...
ms.author: edupont
---
# <a name="create-number-series"></a><a name="create-number-series"></a>Create Number Series
...
## <a name="gaps-in-number-series"></a><a name="gaps-in-number-series"></a>Gaps in Number Series
...
## <a name="behavior-of-the-no-field-on-documents-and-cards"></a><a name="behavior-of-the-no-field-on-documents-and-cards"></a>Behaviour of the No. field on documents and cards
...
## <a name="to-create-a-new-number-series"></a><a name="to-create-a-new-number-series"></a>To create a new number series
...
## <a name="to-create-relationships-between-number-series"></a><a name="to-create-relationships-between-number-series"></a>To create relationships between number series
...
## <a name="to-set-up-where-a-number-series-is-used"></a><a name="to-set-up-where-a-number-series-is-used"></a>To set up where a number series is used
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)
