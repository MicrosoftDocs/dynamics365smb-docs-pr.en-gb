...
ms.author: bholtorf
---
# <a name="work-with-accounting-periods-and-fiscal-years" />Work with Accounting Periods and Fiscal Years
...
## <a name="creating-a-new-fiscal-year" />Creating a new fiscal year

You can create accounting periods in bulk by using the **Create Fiscal Year** batch job, or by doing so manually.

### <a name="how-to-create-accounting-periods-in-bulk" />How to create accounting periods in bulk
...
### <a name="how-to-create-accounting-periods-manually" />How to create accounting periods manually
...
## <a name="closing-a-fiscal-year" />Closing a fiscal year
...
## <a name="posting-entries-to-a-closed-fiscal-year" />Posting entries to a closed fiscal year
