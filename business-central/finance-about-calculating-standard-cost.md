...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />About Calculating Standard Cost
...
## <a name="setting-up-standard-costs" />Setting Up standard costs
...
### <a name="material-costs" />Material costs
...
### <a name="capacity-costs" />Capacity costs
...
### <a name="subcontractor-costs" />Subcontractor costs
...
## <a name="updating-standard-costs" />Updating standard costs
