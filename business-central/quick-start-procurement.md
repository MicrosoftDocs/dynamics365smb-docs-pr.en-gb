...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Procurement Quick Start
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a>Set up vendors
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Set up a new vendor
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Create new purchase orders
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>To create a purchase order
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Create a purchase invoice
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>How to create and post a purchase invoice
