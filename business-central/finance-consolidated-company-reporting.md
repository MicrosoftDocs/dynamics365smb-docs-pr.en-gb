...
## <a name="to-eliminate-repeated-transactions"></a>To eliminate repeated transactions
...
## <a name="to-export-and-import-consolidated-data-between-databases"></a>To export and import consolidated data between databases
