...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Walkthrough: Setting Up and Invoicing Sales Prepayments
...
## <a name="about-this-walkthrough" />About This Walkthrough
...
## <a name="set-up-prepayments" />Set Up Prepayments
...
### <a name="to-set-up-number-series-for-prepayments" />To set up number series for prepayments
...
### <a name="to-block-shipments-for-unpaid-prepayment" />To block shipments for unpaid prepayment
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />To assign default prepayment percentages to customers and items
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />To specify an account for sales prepayments in general posting setup
...
## <a name="create-an-order-that-requires-a-prepayment" />Create an Order that Requires a Prepayment
...
### <a name="to-create-a-sales-order-with-a-prepayment" />To create a sales order with a prepayment
...
## <a name="create-a-prepayment-invoice" />Create a Prepayment Invoice
...
### <a name="to-create-a-prepayment-invoice" />To create a prepayment invoice
...
## <a name="create-an-additional-prepayment-invoice" />Create an Additional Prepayment Invoice
...
### <a name="to-create-an-additional-prepayment-invoice" />To create an additional prepayment invoice
...
## <a name="apply-the-prepayments" />Apply the Prepayments
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />To apply a payment to the prepayment invoices
...
## <a name="invoice-the-remaining-amount" />Invoice the Remaining Amount
...
### <a name="to-invoice-the-remaining-amount" />To invoice the remaining amount
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically" />Update the Status of Prepaid Orders and Invoices Automatically
...
## <a name="see-related-microsoft-trainingtrainingmodulesprepayment-invoices-dynamics--business-central" />See related [Microsoft training](/training/modules/prepayment-invoices-dynamics-365-business-central/)
