...
ms.locfileid: "9075662"
---
# <a name="set-up-printers"></a>Set Up Printers

Printing documents and reports from [!INCLUDE[prod_short](includes/prod_short.md)] is an important task for business users. Users will typically want to send print jobs directly to one of your organisation's printers&mdash;no matter which [!INCLUDE[prod_short](includes/prod_short.md)] client or app they're using. Because [!INCLUDE[prod_short](includes/prod_short.md)] online is a cloud service, it can't directly reach local printers connected to users' devices, but it can connect to cloud-enabled printers.
...
- [!INCLUDE[prod_short](includes/prod_short.md)] on-premises:
  ...
  - An application for Business Central is registered in your Azure AD tenant and [!INCLUDE[prod_short](includes/prod_short.md)]
      ...
      Like other Azure services that work with [!INCLUDE[prod_short](includes/prod_short.md)], Universal Print requires an app registration for [!INCLUDE[prod_short](includes/prod_short.md)] in Azure Active Directory (Azure AD). The app registration provides authentication and authorisation services between [!INCLUDE[prod_short](includes/prod_short.md)] and Universal Print.
...
- A Universal Print subscription/licence for your organisation.
    ...
    For more information, see [Licence Universal Print](/universal-print/fundamentals/universal-print-license).
...
1. Assign Universal Print licences to yourself and other users.
    ...
    - With [!INCLUDE[prod_short](includes/prod_short.md)] online, you assign licences by using the Microsoft 365 admin centre.

      For more information, see [Microsoft Admin Centre Help - Assign licences to users](/microsoft-365/admin/manage/assign-licenses-to-users).
    ...
    - With [!INCLUDE[prod_short](includes/prod_short.md)] on-premises, you assign licences in your Azure tenant using the Azure portal.
      ...
      For more information, see [Azure Directory - Assign or remove licences in the Azure Active Directory portal](/azure/active-directory/fundamentals/license-users-groups).
...
3. Follow the on-screen instructions.
    ...
    These actions verify your Azure AD setup (for on-premises), check that your have Universal Print licence, and then finally adding the printers.
