...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Troubleshoot Connectivity for Business Central
...
## <a name="start-the-connectivity-check" />Start the connectivity check
...
## <a name="basic-internet-connectivity" />Basic internet connectivity
...
## <a name="cdn-content-delivery-network-resources-loading" />CDN (content delivery network) resources loading
...
## <a name="user-authentication" />User authentication
...
## <a name="business-central-environments-discovery" />Business Central environments discovery
...
## <a name="application-service-connectivity" />Application service connectivity
...
## <a name="web-server-connectivity" />Web server connectivity
...
## <a name="service-health-status" />Service health status
