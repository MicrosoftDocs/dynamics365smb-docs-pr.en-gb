...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Troubleshoot Connectivity for Business Central
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>Start the connectivity check
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Basic internet connectivity
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>CDN (content delivery network) resources loading
...
## <a name="user-authentication"></a><a name="user-authentication"></a>User authentication
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Business Central environments discovery
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Application service connectivity
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Web server connectivity
...
## <a name="service-health-status"></a><a name="service-health-status"></a>Service health status
