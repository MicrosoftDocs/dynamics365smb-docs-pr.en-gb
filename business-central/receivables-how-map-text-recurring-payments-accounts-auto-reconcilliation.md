...
ms.author: edupont
---
# <a name="map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />Map Text on Recurring Payments to Accounts for Automatic Reconciliation
...
## <a name="to-map-text-on-recurring-payments-to-accounts-for-automatic-reconciliation" />To map text on recurring payments to accounts for automatic reconciliation
...
## <a name="example-text-to-account-mapping-for-bank-fees" />Example: Text-to-Account Mapping for Bank Fees
