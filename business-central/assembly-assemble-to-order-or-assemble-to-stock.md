...
---
# <a name="understanding-assemble-to-order-and-assemble-to-stock"></a><a name="understanding-assemble-to-order-and-assemble-to-stock"></a>Understanding Assemble to Order and Assemble to Stock
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a>Assemble to order
...
## <a name="assemble-to-stock"></a><a name="assemble-to-stock"></a>Assemble to stock
...
## <a name="combination-scenarios"></a><a name="combination-scenarios"></a>Combination scenarios
