...
ms.author: edupont
---
# <a name="make-drop-shipments"></a><a name="make-drop-shipments"></a>Make Drop Shipments
...
## <a name="to-create-a-sales-order-for-drop-shipment"></a><a name="to-create-a-sales-order-for-drop-shipment"></a>To create a sales order for drop shipment
...
## <a name="to-create-the-purchase-order-for-drop-shipment"></a><a name="to-create-the-purchase-order-for-drop-shipment"></a>To create the purchase order for drop shipment
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments"></a><a name="to-create-multiple-purchase-orders-for-drop-shipments"></a>To create multiple purchase orders for drop shipments
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order"></a><a name="to-view-the-linked-purchase-order-from-the-sales-order"></a>To view the linked purchase order from the sales order
...
## <a name="to-post-a-drop-shipment"></a><a name="to-post-a-drop-shipment"></a>To post a drop shipment
