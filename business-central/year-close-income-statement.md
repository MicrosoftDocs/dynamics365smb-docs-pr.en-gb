...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Closing Income Statement Accounts
...
## <a name="to-run-the-close-income-statement-batch-job" />To run the Close Income Statement batch job
...
## <a name="about-the-close-income-statement-batch-job" />About the Close Income Statement Batch Job
