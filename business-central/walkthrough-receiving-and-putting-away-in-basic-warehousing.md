...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Walkthrough: Receiving and Putting Away in Basic Warehouse Configurations
...
## <a name="setting-up-the-location" />Setting up the location

Settings on the **Location Card** page define the company's warehouse flows.  

### <a name="to-set-up-the-location" />To set up the location
...
## <a name="create-the-purchase-order" />Create the purchase order

Purchase orders are the most common type of inbound source document.  

### <a name="to-create-the-purchase-order" />To create the purchase order
...
## <a name="receive-and-put-the-items-away" />Receive and put the items away
...
### <a name="to-receive-and-put-the-items-away" />To receive and put the items away
