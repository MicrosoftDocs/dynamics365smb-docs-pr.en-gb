...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a>Walkthrough: Calculating Work in Progress for a Job
...
## <a name="calculating-wip"></a><a name="calculating-wip"></a><a name="calculating-wip"></a>Calculating WIP
...
### <a name="to-calculate-wip"></a><a name="to-calculate-wip"></a><a name="to-calculate-wip"></a>To calculate WIP
...
### <a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a>To review WIP warnings
...
### <a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a>To recalculate WIP
...
## <a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a>Posting WIP to General Ledger

 Now that Tricia has calculated WIP for this job, they can post it to the general ledger.  

### <a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a>To post WIP to general ledger
...
## <a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a>Reversing a WIP Posting
...
### <a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a>To reverse a WIP posting
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/paths/calculate-post-job-wip/)
