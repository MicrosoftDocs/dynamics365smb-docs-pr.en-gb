...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job" />Walkthrough: Calculating Work in Progress for a Job
...
## <a name="calculating-wip" />Calculating WIP
...
### <a name="to-calculate-wip" />To calculate WIP
...
### <a name="to-review-wip-warnings" />To review WIP warnings
...
### <a name="to-recalculate-wip" />To recalculate WIP
...
## <a name="posting-wip-to-general-ledger" />Posting WIP to General Ledger

 Now that Tricia has calculated WIP for this job, they can post it to the general ledger.  

### <a name="to-post-wip-to-general-ledger" />To post WIP to general ledger
...
## <a name="reversing-a-wip-posting" />Reversing a WIP Posting
...
### <a name="to-reverse-a-wip-posting" />To reverse a WIP posting
