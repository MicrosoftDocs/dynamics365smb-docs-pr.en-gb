...
# <a name="managing-vat-rate-changes" />Managing VAT Rate Changes
...
## <a name="changing-vat-rates" />Changing VAT rates
...
## <a name="the-vat-rate-change-tool" />The VAT Rate Change tool
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Understanding the VAT rate conversion process and limitations
...
### <a name="to-prepare-vat-rate-change-conversions" />To prepare VAT rate change conversions
...
### <a name="to-set-up-the-vat-rate-change-tool" />To set up the VAT rate change tool
...
### <a name="to-perform-vat-rate-change-conversion" />To perform VAT rate change conversion
...
## <a name="see-related-microsoft-trainingtrainingmodulesrate-change-dynamics--business-central" />See related [Microsoft training](/training/modules/rate-change-dynamics-365-business-central/)
