...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Work with Manufacturing Batch Units of Measurement
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />To create a production BOM using a batch unit of measurement
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />To calculate a manufacturing batch unit of measurement on a production order
