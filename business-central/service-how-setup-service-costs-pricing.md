...
# <a name="set-up-pricing-and-additional-costs-for-services" />Set Up Pricing and Additional Costs for Services
...
## <a name="to-set-up-a-service-price-group" />To set up a service price group
...
## <a name="to-set-up-a-service-price-adjustment-group" />To set up a service price adjustment group
...
## <a name="to-set-up-additional-costs-for-services" />To set up additional costs for services
...
### <a name="to-set-up-service-costs" />To set up service costs
...
### <a name="to-specify-a-default-cost-for-service-orders" />To specify a default cost for service orders
