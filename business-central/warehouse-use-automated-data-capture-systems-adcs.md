...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Use Automated Data Capture Systems (ADCS)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>To enable Web Services for ADCS

To use Automated Data Capture System, you must enable the ADCS web service.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>To enable and publish the ADCS web service
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>To set up a warehouse to use ADCS
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>To specify an item to use ADCS
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>To add an ADCS user
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>To specify that a warehouse employee is an ADCS user
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>To create and customise miniforms
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>To create a miniform for ADCS
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>To customise miniform functions
