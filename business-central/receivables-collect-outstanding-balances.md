...
ms.author: edupont
---
# <a name="collect-outstanding-balances" />Collect Outstanding Balances
...
### <a name="to-send-the-customer-statement-report" />To send the Customer Statement report
...
## <a name="reminders" />Reminders

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges" />Finance Charges
...
### <a name="to-create-a-finance-charge-memo-manually" />To create a finance charge memo manually
...
### <a name="to-update-finance-charge-memo-texts" />To update finance charge memo texts
...
### <a name="to-issue-finance-charge-memos" />To issue finance charge memos
...
### <a name="to-cancel-an-issued-finance-charge-memo" />To cancel an issued finance charge memo
...
### <a name="to-view-reminder-and-finance-charge-entries" />To view reminder and finance charge entries
...
## <a name="multiple-interest-rates" />Multiple Interest rates
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)
