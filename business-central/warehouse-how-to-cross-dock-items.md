...
---
# <a name="cross-dock-items"></a><a name="cross-dock-items"></a>Cross-Dock Items
...
## <a name="cross-dock-bins-and-zones"></a><a name="cross-dock-bins-and-zones"></a>Cross-dock bins and zones
...
## <a name="cross-dock-select-lines-for-a-receipt"></a><a name="cross-dock-select-lines-for-a-receipt"></a>Cross-dock select lines for a receipt
...
## <a name="about-the-put-away-worksheet-page"></a><a name="about-the-put-away-worksheet-page"></a>About the Put-away Worksheet page
...
## <a name="to-set-up-the-warehouse-for-cross-docking"></a><a name="to-set-up-the-warehouse-for-cross-docking"></a>To set up the warehouse for cross-docking
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities"></a><a name="to-cross-dock-items-without-viewing-the-opportunities"></a>To cross-dock items without viewing the opportunities
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities"></a><a name="to-cross-dock-items-after-viewing-the-opportunities"></a>To cross-dock items after viewing the opportunities
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a><a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a>To view cross-docked items in a shipment or pick worksheet
