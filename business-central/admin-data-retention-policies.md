...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Define Retention Policies
...
## <a name="required-setups-and-permissions" />Required Setups and Permissions
...
### <a name="to-create-retention-periods" />To create retention periods
...
### <a name="set-up-a-retention-policy" />Set up a retention policy
...
## <a name="applying-retention-policies" />Applying Retention Policies
...
## <a name="viewing-retention-policy-log-entries" />Viewing Retention Policy Log Entries
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Including Your Extension in a Retention Policy (Requires Help from a Developer)
