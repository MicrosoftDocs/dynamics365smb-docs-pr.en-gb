...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Set Up Unrealised VAT for Cash-Based Accounting
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />To use general ledger accounts for unrealised VAT
