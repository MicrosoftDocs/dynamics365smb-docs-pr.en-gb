...
## <a name="create-new-service-declaration"></a><a name="create-new-service-declaration"></a>Create new service declaration
...
## <a name="other-considerations"></a><a name="other-considerations"></a>Other considerations
