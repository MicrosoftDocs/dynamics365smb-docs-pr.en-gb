...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Design Details: Balancing supply and demand
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a><a name="supply-and-demand"></a>Supply and demand
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>The concept of balancing, in brief
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Process orders before the planning start date
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Serial and lot numbers and order-to-order links are exempt from the previous period
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Load inventory profiles
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Item dimensions are separated
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Serial and lot numbers are loaded by specification level
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Order-to-order links are never broken
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Component need is loaded according to production order changes
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Consume safety stock
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>Forecast demand is reduced by sales orders
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>Blanket order demand is reduced by sales orders
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a><a name="prioritize-orders"></a>Prioritise orders
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Priorities on the demand side
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Priorities on the supply side
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Priority related to the state of supply and demand
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Balancing supply with demand
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Rules for actions for supply events
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Determine the supply quantity
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Order tracking links during planning
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Close balanced supply and demand
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Create the planning line (Suggested Action)
