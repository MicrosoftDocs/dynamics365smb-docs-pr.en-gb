...
---
# <a name="design-details-balancing-supply-and-demand" />Design Details: Balancing supply and demand
...
## <a name="supply-and-demand" />Supply and demand
...
## <a name="the-concept-of-balancing-in-brief" />The concept of balancing, in brief
...
## <a name="process-orders-before-the-planning-start-date" />Process orders before the planning start date
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period" />Serial and lot numbers and order-to-order links are exempt from the previous period
...
## <a name="load-inventory-profiles" />Load inventory profiles
...
### <a name="item-dimensions-are-separated" />Item dimensions are separated
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level" />Serial and lot numbers are loaded by specification level
...
### <a name="order-to-order-links-are-never-broken" />Order-to-order links are never broken
...
### <a name="component-need-is-loaded-according-to-production-order-changes" />Component need is loaded according to production order changes
...
### <a name="consume-safety-stock" />Consume safety stock
...
### <a name="forecast-demand-is-reduced-by-sales-orders" />Forecast demand is reduced by sales orders
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders" />Blanket order demand is reduced by sales orders
...
## <a name="prioritize-orders" />Prioritise orders
...
### <a name="priorities-on-the-demand-side" />Priorities on the demand side
...
### <a name="priorities-on-the-supply-side" />Priorities on the supply side
...
### <a name="priority-related-to-the-state-of-supply-and-demand" />Priority related to the state of supply and demand
...
## <a name="balancing-supply-with-demand" />Balancing supply with demand
...
### <a name="rules-for-actions-for-supply-events" />Rules for actions for supply events
...
### <a name="determine-the-supply-quantity" />Determine the supply quantity
...
### <a name="order-tracking-links-during-planning" />Order tracking links during planning
...
## <a name="close-balanced-supply-and-demand" />Close balanced supply and demand
...
### <a name="create-the-planning-line-suggested-action" />Create the planning line (Suggested Action)
