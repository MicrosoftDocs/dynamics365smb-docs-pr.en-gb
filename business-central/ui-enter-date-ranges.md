...
# <a name="work-with-calendar-dates-and-times" />Work with Calendar Dates and Times
...
## <a name="check-your-region-and-language-settings" />Check your region and language settings
...
### <a name="picking-dates-from-the-calendar" />Picking dates from the calendar
...
### <a name="day-week-year-pattern" />Day\-week\-year pattern
...
### <a name="digit-patterns" />Digit patterns
...
### <a name="closing-date" />Closing Date
...
## <a name="entering-combined-dates-and-times" />Entering Combined Dates and Times
