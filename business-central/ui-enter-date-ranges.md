...
# <a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a><a name="work-with-calendar-dates-and-times"></a>Work with Calendar Dates and Times
...
## <a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a><a name="check-your-region-and-language-settings"></a>Check your region and language settings
...
### <a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a><a name="picking-dates-from-the-calendar"></a>Picking dates from the calendar
...
### <a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a><a name="day-week-year-pattern"></a>Day\-week\-year pattern
...
### <a name="digit-patterns"></a><a name="digit-patterns"></a><a name="digit-patterns"></a>Digit patterns
...
### <a name="today"></a><a name="today"></a><a name="today"></a>Today
...
### <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Work Date
...
### <a name="closing-date"></a><a name="closing-date"></a><a name="closing-date"></a>Closing Date
...
## <a name="setting-ranges"></a><a name="setting-ranges"></a><a name="setting-ranges"></a><a name="BKMK_SettingDateRanges"></a> Setting Ranges
...
## <a name="use-date-formulas"></a><a name="use-date-formulas"></a><a name="use-date-formulas"></a>Use Date Formulas
...
## <a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a><a name="entering-combined-dates-and-times"></a>Entering Combined Dates and Times
