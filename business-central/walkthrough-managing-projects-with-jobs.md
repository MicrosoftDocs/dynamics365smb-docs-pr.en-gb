...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs" />Walkthrough: Managing Projects with Jobs
...
### <a name="setting-up-a-job" />Setting Up a Job
...
### <a name="handling-fixed-prices" />Handling Fixed Prices
...
### <a name="copying-a-job" />Copying a Job
...
### <a name="making-payment-by-installment" />Making Payment by Installment
...
## <a name="preparing-sample-data" />Preparing Sample Data

 To prepare for this walkthrough, you must add Tricia as a new resource.  

### <a name="to-prepare-the-sample-data" />To prepare the sample data
...
### <a name="to-create-a-job-journal-batch" />To create a Job Journal batch
...
## <a name="setting-up-a-job-1" />Setting Up a Job
...
### <a name="to-set-up-a-job" />To set up a job
...
### <a name="to-customize-pricing" />To customise pricing
...
### <a name="to-add-job-tasks" />To add job tasks
...
### <a name="to-create-planning-lines" />To create planning lines
...
## <a name="calculating-remaining-usage" />Calculating Remaining Usage
...
### <a name="to-calculate-remaining-usage" />To calculate remaining usage
...
## <a name="creating-and-posting-a-job-sales-invoice" />Creating and Posting a Job Sales Invoice
...
### <a name="to-create-a-job-sales-invoice" />To create a job sales invoice
...
### <a name="to-post-a-new-sales-invoice" />To post a new sales invoice
...
### <a name="to-view-the-posted-invoice" />To view the posted invoice
...
### <a name="to-open-the-statistics-page" />To open the Statistics page
...
## <a name="handling-fixed-prices-1" />Handling Fixed Prices
...
### <a name="to-manage-fixed-pricing-in-jobs" />To manage fixed pricing in jobs
...
### <a name="to-enter-hours-in-the-job-journal" />To enter hours in the Job Journal
...
## <a name="copying-jobs" />Copying Jobs
...
### <a name="to-copy-a-job" />To copy a job
...
## <a name="making-payments-by-installments" />Making Payments by Installments
...
### <a name="to-set-up-a-new-account" />To set up a new account
...
### <a name="to-make-a-payment-by-installment" />To make a payment by installment
...
### <a name="to-create-an-invoice" />To create an invoice
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/paths/create-jobs/)
