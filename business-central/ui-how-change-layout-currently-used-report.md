...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Legacy) Set the Layout Used by a Report
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />To change which report layout to use for a report or document
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />To change the custom layout to use for a report layout
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/change-documents-dynamics-365-business-central/index)
