...
### <a name="allow-substitute-customer-or-vendor-posting-groups-on-documents"></a>Allowing substitute customer or vendor posting groups on documents
...
## <a name="copy-posting-setup-lines"></a>Copying posting setup lines
