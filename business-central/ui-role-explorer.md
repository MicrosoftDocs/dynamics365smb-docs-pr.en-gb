...
---
# <a name="finding-pages-from-a-feature-overview"></a>Finding Pages from a Feature Overview
...
You can open the feature overview from the Role Centre and all list pages and from the **Tell Me** window.

- On your Role Centre or any list page, choose the ![Menu button](media/ui_menu_button.png "Menu button") button to the right of the navigation bar.
