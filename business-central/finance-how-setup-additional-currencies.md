...
>
> For example, you have a large amount of sales ledger in British pounds (GBP), and you have set up your additional reporting currency (ACY) to be GBP. In this scenario, amounts in the sales ledger that use GBP will not be adjusted for currency exchange gains/losses in the ACY, only amounts in the sales ledger that are in other currencies. That means that if you use ACY to report your financial statements, it might result in understated or overstated outstanding balances of sales ledger.
