...
ms.author: edupont
---
# <a name="create-bin-contents" />Create Bin Contents
...
## <a name="to-create-bin-content-manually" />To create bin content manually
...
## <a name="to-create-bin-content-with-a-worksheet" />To create bin content with a worksheet
