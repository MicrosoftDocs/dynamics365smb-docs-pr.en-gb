...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Walkthrough: Making Cash Flow Forecasts Using Financial Reports
...
## <a name="setting-up-a-new-financial-report-name" />Setting up a new financial report name
...
### <a name="set-up-a-new-financial-report-name" />Set up a new financial report name
...
## <a name="setting-up-row-definition-lines" />Setting up row definition lines
...
### <a name="set-up-row-definition-lines" />Set up row definition lines
...
## <a name="setting-up-a-new-column-definition" />Setting up a new column definition
...
### <a name="set-up-a-new-column-definition" />Set up a new column definition
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Assigning the column definition to the financial report name

Ken is now ready to assign the column definition to the financial report name.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Assign the column definition to the financial report name
...
## <a name="view-and-print-the-cash-flow-forecast" />View and print the cash flow forecast
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics-365-business-central" />See related [Microsoft training](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
