...
## <a name="setting-up-accounts-sales-people"></a>Setting Up Accounts Sales People
...
## <a name="minimum-permissions-for-user-accounts-in-includecrm_mdincludescrm_mdmd"></a>Minimum Permissions for User Accounts in [!INCLUDE[crm_md](includes/crm_md.md)]
