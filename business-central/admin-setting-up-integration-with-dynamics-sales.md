...
## <a name="minimum-permissions-for-user-accounts-in-includecrmmdincludescrmmdmd"></a>Minimum Permissions for User Accounts in [!INCLUDE[crm_md](includes/crm_md.md)]
