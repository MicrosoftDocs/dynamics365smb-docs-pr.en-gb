...
> [!IMPORTANT]  
> Do not use the administrator account for [!INCLUDE[d365fin](includes/cds_long_md.md)] for synchronisation. Doing so will break the synchronisation.
