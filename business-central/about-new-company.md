...
---
# <a name="create-new-companies-in-"></a><a name="create-new-companies-in-"></a><a name="create-new-companies-in-"></a>Create New Companies in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="choose-the-right-template"></a><a name="choose-the-right-template"></a><a name="choose-the-right-template"></a>Choose the right template
...
## <a name="copy-a-company"></a><a name="copy-a-company"></a><a name="copy-a-company"></a>Copy a company
...
## <a name="set-up-the-company"></a><a name="set-up-the-company"></a><a name="set-up-the-company"></a>Set up the company
...
## <a name="companies-and-environments"></a><a name="companies-and-environments"></a><a name="companies-and-environments"></a>Companies and environments
...
## <a name="changing-a-companys-name"></a><a name="changing-a-companys-name"></a><a name="changing-a-companys-name"></a>Changing a company's name
...
## <a name="add-contoso-coffee"></a><a name="add-contoso-coffee"></a><a name="add-contoso-coffee"></a>Add Contoso Coffee
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/create-new-companies-dynamics-365-business-central/)
