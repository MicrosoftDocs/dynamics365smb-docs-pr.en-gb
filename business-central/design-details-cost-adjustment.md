...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Design Details: Cost Adjustment
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Detecting the Adjustment
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a><a name="item-application-entry"></a>Item Application Entry
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Average Cost Adjustment Entry Point
...
### <a name="order-level"></a><a name="order-level"></a><a name="order-level"></a>Order Level
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Manual versus Automatic Cost Adjustment
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Adjust Cost - Item Entries Batch Job
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a><a name="value-entries-1"></a>Value Entries (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Relation Entries in the G/L – Item Ledger Relation Table (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>General Ledger Entries (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a><a name="value-entries-2"></a>Value Entries (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Relation Entries in the G/L – Item Ledger Relation Table (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>General Ledger Entries (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Automatic Cost Adjustment
...
### <a name="example-1"></a><a name="example-1"></a><a name="example-1"></a>Example
