...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Design Details: Cost Adjustment
...
## <a name="detecting-the-adjustment" />Detecting the Adjustment
...
### <a name="item-application-entry" />Item Application Entry
...
### <a name="average-cost-adjustment-entry-point" />Average Cost Adjustment Entry Point
...
### <a name="order-level" />Order Level
...
## <a name="manual-versus-automatic-cost-adjustment" />Manual versus Automatic Cost Adjustment
...
## <a name="adjust-cost---item-entries-batch-job" />Adjust Cost - Item Entries Batch Job
...
## <a name="automatic-cost-adjustment" />Automatic Cost Adjustment
