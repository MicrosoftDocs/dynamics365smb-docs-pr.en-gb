...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />Mapping the Tables and Fields to Synchronise
...
## <a name="mapping-integration-tables" />Mapping integration tables
...
### <a name="additional-mappings" />Additional mappings
...
### <a name="strategies-for-auto-resolving-conflicts" />Strategies for auto-resolving conflicts
...
## <a name="mapping-integration-fields" />Mapping integration fields
...
### <a name="handle-differences-in-field-values" />Handle differences in field values
...
### <a name="handle-missing-option-values" />Handle missing option values
...
## <a name="couple-records" />Couple records
...
## <a name="filter-records-and-rows" />Filter records and rows
...
## <a name="create-new-records" />Create new records
...
### <a name="to-create-new-records-during-synchronization" />To create new records during synchronisation

1. Choose the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Integration Table Mappings**, and then choose the related link.
2. In the table mapping entry in the list, clear the **Synch. Only Coupled Records** field.  

## <a name="use-configuration-templates-on-table-mappings" />Use configuration templates on table mappings
...
### <a name="to-specify-configuration-templates-on-a-table-mapping" />To specify configuration templates on a table mapping
