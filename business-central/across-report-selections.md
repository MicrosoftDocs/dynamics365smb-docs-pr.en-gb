...
ms.author: bholtorf
---
# <a name="report-selection-for-documents-in-business-central" />Report Selection for Documents in Business Central
...
## <a name="available-report-selections" />Available report selections
...
## <a name="example-report-selection-for-sales-documents" />Example: Report selection for sales documents
