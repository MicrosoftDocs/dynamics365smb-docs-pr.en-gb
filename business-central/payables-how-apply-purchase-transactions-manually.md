...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Reconcile Vendor Payments with the Payment Journal or from Vendor Ledger Entries
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />To apply a payment to a single or multiple vendor ledger entries
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />To apply a credit memo to a single or multiple vendor ledger entries
...
## <a name="to-apply-posted-vendor-ledger-entries" />To apply posted vendor ledger entries
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />To apply vendor ledger entries in different currencies to one another
...
## <a name="to-unapply-an-application-of-vendor-entries" />To unapply an application of vendor entries
