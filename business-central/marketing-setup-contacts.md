...
ms.author: edupont
---
# <a name="set-up-contacts" />Set Up Contacts
...
## <a name="to-assign-industry-groups-to-a-contact" />To assign industry groups to a contact
...
## <a name="to-assign-mailing-groups-to-a-contact" />To assign mailing groups to a contact
...
## <a name="to-define-a-contacts-alternate-address" />To define a contact's alternate address
...
## <a name="to-assign-job-responsibilities-to-a-contact" />To assign job responsibilities to a contact
...
## <a name="to-assign-organizational-levels-to-a-contact" />To assign organisational levels to a contact
...
## <a name="to-assign-web-sources-to-a-contact" />To assign web sources to a contact
...
## <a name="to-assign-business-relations-to-a-contact" />To assign business relations to a contact
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synchronising Contacts with Customers, Vendors, and Bank Accounts
...
## <a name="searching-for-duplicate-contacts" />Searching for Duplicate Contacts
