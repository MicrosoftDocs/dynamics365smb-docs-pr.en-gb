...
ms.author: edupont
---
# <a name="set-up-contacts"></a><a name="set-up-contacts"></a>Set Up Contacts
...
## <a name="to-assign-industry-groups-to-a-contact"></a><a name="to-assign-industry-groups-to-a-contact"></a>To assign industry groups to a contact
...
## <a name="to-assign-mailing-groups-to-a-contact"></a><a name="to-assign-mailing-groups-to-a-contact"></a>To assign mailing groups to a contact
...
## <a name="to-define-a-contacts-alternate-address"></a><a name="to-define-a-contacts-alternate-address"></a>To define a contact's alternate address
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a><a name="to-assign-job-responsibilities-to-a-contact"></a>To assign job responsibilities to a contact
...
## <a name="to-assign-organizational-levels-to-a-contact"></a><a name="to-assign-organizational-levels-to-a-contact"></a>To assign organisational levels to a contact
...
## <a name="to-assign-web-sources-to-a-contact"></a><a name="to-assign-web-sources-to-a-contact"></a>To assign web sources to a contact
...
## <a name="to-assign-business-relations-to-a-contact"></a><a name="to-assign-business-relations-to-a-contact"></a>To assign business relations to a contact
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a><a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons"></a>Automatically Copying Specific Information from Contact Companies to Contact Persons
...
## <a name="use-predefined-defaults-on-new-contacts"></a><a name="use-predefined-defaults-on-new-contacts"></a>Use Predefined Defaults on New Contacts
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a><a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts"></a>Synchronising Contacts with Customers, Vendors, and Bank Accounts
...
## <a name="searching-for-duplicate-contacts"></a><a name="searching-for-duplicate-contacts"></a>Searching for Duplicate Contacts
