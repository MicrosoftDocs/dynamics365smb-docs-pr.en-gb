...
---
# <a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a>Design Details: Planning Parameters
...
## <a name="define-whether-the-item-is-planned"></a><a name="define-whether-the-item-is-planned"></a><a name="define-whether-the-item-is-planned"></a>Define whether the item is planned
...
## <a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a>Define when to reorder
...
## <a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a>Define how much to reorder
...
### <a name="reordering-policies"></a><a name="reordering-policies"></a><a name="reordering-policies"></a>Reordering policies
...
## <a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a>Optimise when and how much to reorder
...
## <a name="modify-the-supply-orders"></a><a name="modify-the-supply-orders"></a><a name="modify-the-supply-orders"></a>Modify the supply orders
...
## <a name="delimit-the-item"></a><a name="delimit-the-item"></a><a name="delimit-the-item"></a>Delimit the item
...
## <a name="use-low-level-codes-to-manage-derived-demand"></a><a name="use-low-level-codes-to-manage-derived-demand"></a><a name="use-low-level-codes-to-manage-derived-demand"></a>Use low-level codes to manage derived demand
