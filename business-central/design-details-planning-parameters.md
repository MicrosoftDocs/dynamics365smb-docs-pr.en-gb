...
---
# <a name="design-details-planning-parameters" />Design Details: Planning Parameters
...
## <a name="define-whether-the-item-is-planned" />Define whether the item is planned
...
## <a name="define-when-to-reorder" />Define when to reorder
...
## <a name="define-how-much-to-reorder" />Define how much to reorder
...
### <a name="reordering-policies" />Reordering policies
...
## <a name="optimize-when-and-how-much-to-reorder" />Optimise when and how much to reorder
...
## <a name="modify-the-supply-orders" />Modify the supply orders
...
## <a name="delimit-the-item" />Delimit the item
...
## <a name="use-low-level-codes-to-manage-derived-demand" />Use low-level codes to manage derived demand
