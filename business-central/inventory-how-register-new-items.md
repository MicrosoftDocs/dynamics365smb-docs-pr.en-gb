...
ms.author: edupont
---
# <a name="register-new-items" />Register New Items
...
## <a name="to-create-a-new-item-card" />To create a new item card
...
### <a name="to-save-the-item-card-as-a-template" />To save the item card as a template
...
### <a name="items-used-in-production-orders" />Items used in production orders
...
## <a name="to-set-up-multiple-vendors-for-an-item" />To set up multiple vendors for an item
...
## <a name="set-up-item-substitutions" />Set up item substitutions

You can set up items to have replacements, such as other items that can be used in place of the original item.

### <a name="to-make-an-item-substitution" />To make an item substitution
...
## <a name="deleting-item-cards" />Deleting item cards
...
## <a name="manage-inventory-in-warehouses" />Manage inventory in warehouses
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-items" />See related [Microsoft training](/training/modules/create-items/)
