...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />Convert Service Contracts that Include VAT Amounts
...
### <a name="to-correct-an-invoice-for-a-prepaid-service-contract" />To correct an invoice for a prepaid service contract
...
### <a name="to-create-a-credit-memo-for-vat-difference" />To create a credit memo for VAT difference
...
### <a name="to-create-contract-expiration-dates-in-contract-lines" />To create contract expiration dates in contract lines
...
### <a name="to-create-a-new-credit-memo" />To create a new credit memo
