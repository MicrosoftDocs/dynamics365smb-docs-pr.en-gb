...
ms.author: edupont
---
# <a name="receive-and-convert-electronic-documents" />Receive and Convert Electronic Documents
...
### <a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice" />To receive and convert an electronic invoice to a purchase invoice
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics-365-business-centralindex" />See related [Microsoft training](/training/modules/electronic-documents-dynamics-365-business-central/index)
