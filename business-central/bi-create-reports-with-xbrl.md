...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Create Reports with XBRL
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL comprises the following components
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Layered taxonomies
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>Set up XBRL lines
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Import an XBRL taxonomy
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Update an XBRL taxonomy
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>See related training at [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
