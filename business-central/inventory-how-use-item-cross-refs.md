...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a>Use Item References
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>To start using item references
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>To set up an item reference
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>To enter a vendor's item description on a document
