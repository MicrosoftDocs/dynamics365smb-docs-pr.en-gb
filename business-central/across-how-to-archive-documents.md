...
---
# <a name="archive-documents" />Archive Documents
...
## <a name="to-set-up-automatic-document-archiving" />To set up automatic document archiving
...
## <a name="to-manually-archive-a-sales-order" />To manually archive a sales order
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />To restore a non-posted sales order from the archive
...
## <a name="to-delete-archived-sales-orders" />To delete archived sales orders
