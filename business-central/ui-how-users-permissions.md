...
## <a name="to-group-users-in-a-user-group"></a>To group users in a user group
...
When users or user groups are created, you must assign permission sets to each to define which object a user can access. First, you must organise the relevant permissions in permission sets. For more information, see the "To create or edit a permission set" section.
...
## <a name="to-create-or-edit-a-permission-set"></a>To create or edit a permission set
...
## <a name="to-create-or-edit-permissions"></a>To create or edit permissions
...
## <a name="to-assign-permission-sets-to-users-or-user-groups"></a>To assign permission sets to users or user groups
...
### <a name="to-assign-a-permission-set-in-the-permission-set-by-user-window"></a>To assign a permission set in the **Permission Set by User** window  
...
## <a name="to-view-or-edit-a-users-permissions"></a>To view or edit a user's permissions
1. Choose the ![Lightbulb that opens the Tell Me feature](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Users**, and then choose the related link.
