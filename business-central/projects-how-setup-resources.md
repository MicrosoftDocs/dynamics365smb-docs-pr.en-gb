...
> [!NOTE]
> You can purchase external resources, for example to invoice a supplier for work delivered. For more information, see [Record Purchases](purchasing-how-record-purchases.md).<br /><br />
