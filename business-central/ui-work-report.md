...
ms.locfileid: "8655235"
---
# <a name="run-and-print-reports"></a>Run and Print Reports

A report gathers information based on a specified set of criteria. It organises and presents the information in an easy-to-read format that you can print or save as a file. There are many reports that you can access throughout the application. The reports typically provide information related to the context of the page you're on. For example, the **Customer** page includes reports for the top 10 customers, sales statistics, and more.
...
> [!TIP]
> The **Microsoft Excel Document (data only)** and **XML Document** options are mostly for advanced purposes. You'd typically use these options for doing detailed data analysis. For more information, see [Analysing Report Data with Excel and XML](report-analyze-excel.md).
>
...
## <a name="scheduling-a-report-to-run-later"></a><a name="ScheduleReport"></a> Scheduling a report to run later
...
You can choose to save the report to a file (like Excel, Word, or PDF), print it, or only generate the report. If you choose to save the report to a file, then the processed report is sent to the **Report Inbox** area on your Role Centre, where you can view it.  
...
A report layout controls what is shown on a report, how it's arranged, and how it's styled. If you want to switch to a different layout, see [Set the Layout Used by a Report](ui-set-report-layout.md). Or, if you want to customise your own report layout, see [Get Started Creating Layouts](ui-get-started-layouts.md).
