...
### <a name="send-to-excel"></a>Send to Excel
...
#### <a name="microsoft-excel-document-data-and-layout"></a>[Microsoft Excel Document (data and layout)](#tab/data-and-layout)

This option is only available for reports that use an RDLC layout. It exports the report results with the RDLC layout applied. Use this option if you want to export the data one time, and only want to make minor changes to its appearance, such as font and colour scheme.

#### <a name="microsoft-excel-document-data-only"></a><a name="exportdataonly"></a>[Microsoft Excel Document (data only)](#tab/data-only)
