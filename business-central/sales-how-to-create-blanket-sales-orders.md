...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Work with Blanket Sales Orders or Blanket Purchase Orders
...
## <a name="to-create-a-blanket-sales-order" />To create a blanket sales order
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />To create a sales order from a blanket sales order
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />To view the status of a blanket sales order
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />To view unposted and posted blanket sales order lines
