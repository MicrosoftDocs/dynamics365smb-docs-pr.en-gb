...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>How To Use Approval Workflows
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Request a record approval
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Cancel approval requests
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Approve or reject approval requests
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Delegate approval requests
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Manage overdue approval requests
