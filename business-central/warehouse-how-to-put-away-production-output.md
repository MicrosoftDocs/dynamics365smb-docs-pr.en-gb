...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />To put away production output with a inventory put-away
...
### <a name="to-put-output-away-with-an-inventory-put-away" />To put output away with a inventory put-away
