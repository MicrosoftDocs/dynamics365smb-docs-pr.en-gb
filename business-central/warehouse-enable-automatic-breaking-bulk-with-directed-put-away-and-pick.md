...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick" />Enable Automatic Breaking Bulk with Directed Put-away and Pick
...
## <a name="breakbulk-in-picks" />Breakbulk in picks
...
## <a name="breakbulk-in-put-aways" />Breakbulk in put-aways
...
## <a name="breakbulk-in-movements" />Breakbulk in movements
