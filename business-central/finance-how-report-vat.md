...
# <a name="report-vat-to-tax-authorities" />Report VAT to Tax Authorities
...
### <a name="submit-an-ec-sales-list-report" />Submit an EC sales list report
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />To connect to your tax authority's web service
...
### <a name="to-set-up-vat-return-periods" />To set up VAT return periods
...
## <a name="to-prepare-and-submit-a-vat-report" />To prepare and submit a VAT report
...
## <a name="viewing-communications-with-your-tax-authority" />Viewing communications with your tax authority
...
## <a name="submitting-vat-reports-manually" />Submitting VAT reports manually
...
## <a name="vat-settlement" />VAT settlement
...
## <a name="configuring-your-own-vat-reports" />Configuring your own VAT reports
