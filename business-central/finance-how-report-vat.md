...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Report VAT to Tax Authorities
...
## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>About the VAT Return report
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>To set up VAT reports in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>To set up VAT return periods
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>To prepare and submit a VAT report
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Submitting VAT reports manually
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a>VAT settlement
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configuring your own VAT reports
