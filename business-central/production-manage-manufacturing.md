...
description: When demand is planned for and the materials have been issued according to production BOMs, then the actual production operations can start and be executed in the sequence defined by the works order routing.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
|**To**|**See**|  
|------------|-------------|  
|Understand how works orders work.|[About Works Orders](production-about-production-orders.md)|
|Create works orders manually.|[Create Works Orders](production-how-to-create-production-orders.md)|
|Outsource all or selected operations in a works order to a subcontractor.|[Subcontract Manufacturing](production-how-to-subcontract-manufacturing.md)|
|Record and post production output along with material and time consumption for a single released works order line.|[Post Consumption and Output for One Released Works Order Line](production-how-to-register-consumption-and-output.md)|  
|Batch post the quantity of components used per operation in a journal that can processes multiple planned works orders.|[Batch Post Consumption](production-how-to-post-consumption.md)|
|Post the quantity of finished items and the time spent per operation in a journal that can processes multiple released works orders.|[Batch Post Output and Run Times](production-how-to-post-output-quantity.md)|
...
|View the shop floor load as a result of planned and released works orders.|[View the Load in Work and Machine Centres](production-how-to-view-the-load-on-work-centers.md)|  
|Use the **Capacity Journal** page to post consumed capacities that are not assigned to a works order, such as maintenance work.|[Post Capacities](production-how-to-post-capacities.md)|  
|Calculate and adjust the cost of finished production items and consumed components for financial reconciliation.|[About Finished Works Order Costs](finance-about-finished-production-order-costs.md)|  
