...
---
# <a name="flows-for-production-assembly-and-jobs" />Flows for Production, Assembly, and Jobs
...
## <a name="overview-of-different-configuration-options" />Overview of different configuration options
...
### <a name="inbound-flow-put-away" />Inbound flow (put-away)
...
### <a name="outbound-flow-pick" />Outbound flow (pick)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Warehouses without dedicated warehouse activity
...
## <a name="basic-warehouse-configuration" />Basic warehouse configuration
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Flows to and from production in a basic warehouse configuration
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Flows to and from assembly in a basic warehouse configuration
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Flows for project management in a basic warehouse configuration
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Flows to and from production in advanced warehouse configurations
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Flows to and from assembly in advanced warehouse configurations
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Flows to project management in advanced warehouse configurations
