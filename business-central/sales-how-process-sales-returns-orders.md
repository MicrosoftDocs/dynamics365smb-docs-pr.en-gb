...
ms.author: edupont
---
# <a name="process-sales-return-orders"></a><a name="process-sales-return-orders"></a>Process Sales Return Orders
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents"></a><a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents"></a>Create a sales return order based on one or more posted sales documents
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order"></a><a name="to-create-a-replacement-sales-order-from-a-sales-return-order"></a>To create a replacement sales order from a sales return order
...
## <a name="to-create-return-related-documents-from-a-sales-return-order"></a><a name="to-create-return-related-documents-from-a-sales-return-order"></a>To create return-related documents from a sales return order
...
## <a name="to-create-a-restock-charge"></a><a name="to-create-a-restock-charge"></a>To create a restock charge
