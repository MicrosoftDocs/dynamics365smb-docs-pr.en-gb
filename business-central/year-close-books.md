...
ms.author: jswymer
---
# <a name="closing-the-books" />Closing the Books
...
## <a name="closing-book-process" />Closing Book Process
...
## <a name="what-happens-when-you-close" />What Happens When You Close
