...
ms.author: edupont
---
# <a name="view-load-on-work-and-machine-centers" />View Load on Work and Machine Centres
...
## <a name="to-view-the-load-on-work-centers" />To view the load on work centres
