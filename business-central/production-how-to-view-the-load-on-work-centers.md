...
ms.author: edupont
---
# <a name="view-load-on-work-and-machine-centers"></a><a name="view-load-on-work-and-machine-centers"></a>View Load on Work and Machine Centres
...
## <a name="to-view-the-load-on-work-centers"></a><a name="to-view-the-load-on-work-centers"></a>To view the load on work centres
