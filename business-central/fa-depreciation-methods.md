...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Depreciation Methods for Fixed Assets
...
## <a name="straight-line-depreciation" />Straight-Line Depreciation
...
### <a name="depreciation-period" />Depreciation Period
...
### <a name="fixed-yearly-percentage" />Fixed Yearly Percentage
...
### <a name="fixed-yearly-amount" />Fixed Yearly Amount
...
### <a name="example---straight-line-depreciation" />Example - Straight-Line Depreciation
...
## <a name="declining-balance-1-depreciation" />Reducing-Balance Depreciation
...
### <a name="example---declining-balance-1-depreciation" />Example - Reducing-Balance Depreciation
...
## <a name="declining-balance-2-depreciation" />Double Declining-Balance Depreciation
...
### <a name="example---declining-balance-2-depreciation" />Example - Double Declining-Balance Depreciation
...
## <a name="db1sl-depreciation" />Sum of Digits Depreciation
...
## <a name="half-year-convention-depreciation" />Half-Year Convention Depreciation
...
### <a name="example---half-year-convention-depreciation" />Example - Half-Year Convention Depreciation
...
## <a name="example---db1sl-depreciation-using-half-year-convention" />Example - Sum of Digits Depreciation Using Half-Year Convention
...
## <a name="duplicating-entries-to-more-depreciation-books" />Duplicating Entries to More Depreciation Books
