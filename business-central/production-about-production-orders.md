...
ms.author: edupont
---
# <a name="about-production-orders" />About Production Orders
...
## <a name="production-order-creation" />Production Order Creation
...
## <a name="limitations-on-production-order-creation" />Limitations on Production Order Creation
...
## <a name="production-order-status" />Production Order Status
...
### <a name="simulated-production-order" />Simulated Production Order
...
### <a name="planned-production-order" />Planned Production Order
...
### <a name="firm-planned-production-order" />Firm Planned Production Order
...
### <a name="released-production-order" />Released Production Order
...
### <a name="finished-production-order" />Finished Production Order
...
## <a name="production-order-execution" />Production Order Execution
...
### <a name="material-consumption" />Material Consumption
...
### <a name="production-output" />Production Output
...
### <a name="posting-consumption-and-output" />Posting Consumption and Output
...
### <a name="production-journal" />Production Journal
