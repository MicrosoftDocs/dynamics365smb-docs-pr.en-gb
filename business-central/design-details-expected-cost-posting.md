...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Design Details: Expected Cost Posting
...
## <a name="prerequisites-for-posting-expected-costs" />Prerequisites for posting expected costs
