...
# <a name="sales-quick-start" />Sales Quick Start
...
## <a name="set-up-items-to-sell" />Set up items to sell
...
### <a name="set-up-a-new-item" />Set up a new item
...
## <a name="set-up-customers" />Set up customers
...
### <a name="set-up-a-new-customer" />Set up a new customer
...
### <a name="to-create-a-sales-order" />To create a sales order
...
## <a name="create-a-sales-invoice" />Create a sales invoice
...
### <a name="to-create-and-post-a-sales-invoice" />To create and post a sales invoice
