...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Walkthrough: Tracing Serial/Lot Numbers
...
### <a name="to-create-the-items" />To create the items
...
### <a name="to-purchase-components" />To purchase components
...
### <a name="to-produce-end-items" />To produce end items
...
### <a name="to-sell-the-end-items" />To sell the end items
...
## <a name="tracing-from-usage-to-origin" />Tracing from Usage to Origin
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />To determine which lot included the faulty frame and who supplied it
...
## <a name="tracing-from-origin-to-usage" />Tracing from Origin to Usage
...
### <a name="to-find-all-usage-of-the-faulty-lot" />To find all usage of the faulty lot
...
## <a name="finding-all-records-of-a-seriallot-number" />Finding All Records of a Serial/Lot Number
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-serial-lot-numbers" />See related [Microsoft training](/training/paths/use-serial-lot-numbers/)
