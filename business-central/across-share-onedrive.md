...
## <a name="working-with-different-types-of-files"></a>Working with Different Types of Files
...
## <a name="accessing-your-onedrive"></a>Accessing Your OneDrive
