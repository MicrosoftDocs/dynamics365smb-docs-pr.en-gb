...
# <a name="viewing-service-statistics" />Viewing Service Statistics
...
## <a name="viewing-statistics-for-service-orders" />Viewing Statistics for Service Orders
...
### <a name="view-totals-for-a-service-order" />View totals for a service order
...
### <a name="view-shipping-information" />View shipping information
...
### <a name="view-order-details" />View order details
...
### <a name="analyze-service-order-lines" />Analyse service order lines
...
### <a name="view-customer-information" />View customer information
...
## <a name="viewing-service-item-statistics" />Viewing Service Item Statistics
...
## <a name="use-trendscapes" />Use Trendscapes
...
## <a name="viewing-gains-and-losses-on-contracts" />Viewing Gains and Losses on Contracts
...
## <a name="viewing-statistics-for-posted-service-documents" />Viewing Statistics for Posted Service Documents
...
### <a name="posted-service-shipment-statistics" />Posted Service Shipment Statistics
...
### <a name="posted-service-invoice-statistics" />Posted Service Invoice Statistics
...
### <a name="posted-service-credit-memo-statistics" />Posted Service Credit Memo Statistics
