...
# <a name="manually-synchronize-table-mappings" />Manually Synchronise Table Mappings
...
## <a name="run-a-full-synchronization" />Run a Full Synchronisation
...
### <a name="to-run-a-full-synchronization" />To run a full synchronisation
...
## <a name="synchronizing-all-modified-records" />Synchronising All Modified Records
...
### <a name="to-synchronize-data-for-all-tables" />To synchronise data for all tables
...
## <a name="synchronize-individual-table-mappings" />Synchronise Individual Table Mappings
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />To synchronise records of an integration table mapping
