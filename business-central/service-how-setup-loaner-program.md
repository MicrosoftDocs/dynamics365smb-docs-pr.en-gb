...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Set Up a Loaner Program
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>To set up a loaner
