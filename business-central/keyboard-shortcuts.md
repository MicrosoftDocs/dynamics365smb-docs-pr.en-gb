...
|<kbd>Y</kbd> and <kbd>N</kbd>|Activate **Yes** and **No** buttons in dialogue boxes. Actual keys will vary based on your current language specified in **My Settings**. For example, select <kbd>J</kbd> to activate the **Ja** button when using German language.|
