...
# <a name="the-image-analyzer-extension" />The Image Analyser Extension
...
## <a name="switch-on-the-image-analyzer-extension" />Switch on the Image Analyser extension
...
## <a name="analyze-an-item-image" />Analyse an item image
...
## <a name="analyze-a-contact-person-picture" />Analyse a contact person picture
...
## <a name="use-your-own-computer-vision-api-account" />Use your own Computer Vision API account
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />See how many analyses you have left in the current period
...
## <a name="stop-using-the-image-analyzer-extension" />Stop using the Image Analyser extension
