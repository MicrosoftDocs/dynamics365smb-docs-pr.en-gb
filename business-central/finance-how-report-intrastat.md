...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Work with Intrastat Reporting
...
## <a name="fill-in-the-intrastat-report" />Fill in the Intrastat report
...
## <a name="modify-the-intrastat-report" />Modify the Intrastat report
...
## <a name="validate-intrastat-lines" />Validate Intrastat lines
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Recalculating weight or supplementary unit of measure
...
## <a name="intrastat-rules" />Intrastat rules
...
### <a name="fixed-assets-reporting" />Fixed assets reporting
...
### <a name="intrastat-report-statuses" />Intrastat report statuses
