...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Flush Components According to Operation Output
...
## <a name="automatic-consumption-posting-flushing-methods" />Automatic Consumption Posting (Flushing) methods
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automatic Reporting - Forward Flush the Entire Order
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automatic Reporting - Forward Flushing by Operation
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automatic Reporting - Back Flushing by Operation
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automatic Reporting - Back Flushing the Entire Order
...
## <a name="to-flush-components-according-to-operation-output" />To flush components according to operation output
...
## <a name="flushing-methods" />Flushing methods
