...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Set Up Prices and Discounts
...
## <a name="setting-up-prices-and-discounts" />Setting Up Prices and Discounts
...
## <a name="about-price-lists" />About Price Lists
...
## <a name="set-up-prices" />Set Up Prices
...
## <a name="work-with-invoice-discounts-and-service-charges" />Work with Invoice Discounts and Service Charges
...
## <a name="calculating-the-best-price" />Calculating the Best Price
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/customer-discounts-dynamics-365-business-central/)
