...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a><a name="design-details-item-application"></a>Design Details: Item Application
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a><a name="inventory-increase"></a>Inventory Increase
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a><a name="inventory-decrease"></a>Inventory Decrease
...
## <a name="fixed-application"></a><a name="fixed-application"></a><a name="fixed-application"></a>Fixed Application
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Example – Fixed Application in Purchase Return
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Example – Fixed Application with Average Cost
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Example – Fixed Application in Sales Return
...
## <a name="transfer-application"></a><a name="transfer-application"></a><a name="transfer-application"></a>Transfer Application
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Example – Average Costing Method
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Example – Standard Costing Method
...
## <a name="reapplication"></a><a name="reapplication"></a><a name="reapplication"></a>Reapplication
