...
ms.author: edupont
---
# <a name="design-details-item-application" />Design Details: Item Application
...
## <a name="inventory-increase" />Inventory Increase
...
## <a name="inventory-decrease" />Inventory Decrease
...
## <a name="fixed-application" />Fixed Application
...
### <a name="example--fixed-application-in-purchase-return" />Example – Fixed Application in Purchase Return
...
### <a name="example--fixed-application-with-average-cost" />Example – Fixed Application with Average Cost
...
### <a name="example--fixed-application-in-sales-return" />Example – Fixed Application in Sales Return
...
## <a name="transfer-application" />Transfer Application
...
### <a name="example--average-costing-method" />Example – Average Costing Method
...
### <a name="example--standard-costing-method" />Example – Standard Costing Method
...
## <a name="reapplication" />Reapplication
