...
ms.author: edupont
---
# <a name="field-mapping-when-exporting-payment-files-using-the-amc-banking--fundamentals-extension" />Field Mapping When Exporting Payment Files Using the AMC Banking 365 Fundamentals extension
