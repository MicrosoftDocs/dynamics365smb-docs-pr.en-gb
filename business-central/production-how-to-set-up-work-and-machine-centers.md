...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Set Up Work Centres and Machine Centres
...
## <a name="to-set-up-a-work-center" />To set up a work centre
...
## <a name="considerations-about-capacity" />Considerations about capacity
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Work centre processing multiple orders simultaneously
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Efficient resource can dedicate only part of their work date to productive work
...
### <a name="consolidated-calendar" />Consolidated calendar
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Example - Different Machine Centres Assigned to a Work Centre
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />To set up a capacity constrained machine or work centre
