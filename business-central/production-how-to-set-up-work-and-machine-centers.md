...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Set Up Work Centres and Machine Centres
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>To set up a work centre
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Considerations about capacity
...
### <a name="run-time"></a><a name="run-time"></a>Run time
...
### <a name="setup-time"></a><a name="setup-time"></a>Setup time
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Work centre processing multiple orders simultaneously
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Efficient resource can dedicate only part of their work date to productive work
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Consolidated calendar
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Example - Different Machine Centres Assigned to a Work Centre
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>To set up a capacity constrained machine or work centre
