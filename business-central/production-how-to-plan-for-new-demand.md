...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Plan for New Demand Order by Order
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>To plan for new production order demand
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>To plan for any new demand
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>To make supply orders
