...
ms.author: jswymer
---
# <a name="overview-of-tasks-to-close-accounting-periods"></a><a name="overview-of-tasks-to-close-accounting-periods"></a>Overview of Tasks to Close Accounting Periods
...
## <a name="general-ledger"></a><a name="general-ledger"></a>General ledger
...
## <a name="sales-and-receivables"></a><a name="sales-and-receivables"></a>Sales and receivables
...
## <a name="purchases-and-payables"></a><a name="purchases-and-payables"></a>Purchases and payables
...
## <a name="fixed-assets"></a><a name="fixed-assets"></a>Fixed assets
...
## <a name="calculate-and-process-sales-tax"></a><a name="calculate-and-process-sales-tax"></a>Calculate and process VAT

* Complete VAT statements.  

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/close-fiscal-year-dynamics-365-business-central/)
