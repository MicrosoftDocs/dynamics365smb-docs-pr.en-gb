...
ms.author: edupont
---
# <a name="design-details-warehouse-setup" />Design Details: Warehouse Setup
...
## <a name="bin-and-bin-content" />Bin and Bin Content
...
## <a name="bin-ranking" />Bin Ranking
...
## <a name="first-expired-first-out" />First Expired First Out
...
## <a name="put-away-template" />Put-away Template
