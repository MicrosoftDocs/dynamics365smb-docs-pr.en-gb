...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Manage Work across Multiple Companies in the Company Hub
...
## <a name="company-hub-home-page" />Company hub home page
...
## <a name="assigned-tasks" />Assigned tasks
...
### <a name="my-user-tasks" />My user tasks
...
## <a name="access-the-company-hub" />Access the company hub
...
## <a name="set-up-the-company-hub" />Set up the company hub
