...
# <a name="manage-work-across-multiple-companies-in-the-company-hub"></a><a name="manage-work-across-multiple-companies-in-the-company-hub"></a>Manage Work across Multiple Companies in the Company Hub
...
## <a name="company-hub-home-page"></a><a name="company-hub-home-page"></a>Company hub home page
...
## <a name="assigned-tasks"></a><a name="assigned-tasks"></a>Assigned tasks
...
### <a name="my-user-tasks"></a><a name="my-user-tasks"></a>My user tasks
...
## <a name="access-the-company-hub"></a><a name="access-the-company-hub"></a>Access the company hub
...
## <a name="set-up-the-company-hub"></a><a name="set-up-the-company-hub"></a>Set up the company hub
