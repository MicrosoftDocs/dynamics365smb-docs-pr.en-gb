...
This video shows an example of how to troubleshoot errors that happened while synchronising with Sales. The process will be the same for all integrations. 
