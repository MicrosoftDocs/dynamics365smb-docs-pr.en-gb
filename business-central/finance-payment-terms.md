...
ms.author: edupont
---
# <a name="set-up-payment-terms"></a><a name="set-up-payment-terms"></a>Set Up Payment Terms
...
## <a name="to-set-up-payment-terms"></a><a name="to-set-up-payment-terms"></a>To set up payment terms
