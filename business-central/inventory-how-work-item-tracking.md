...
ms.author: edupont
---
# <a name="track-items-with-serial-lot-and-package-numbers" />Track Items with Serial, Lot, and Package Numbers
...
## <a name="item-tracking-availability" />Item tracking availability
...
## <a name="to-assign-serial-or-lot-numbers-during-an-inbound-transaction" />To assign serial or lot numbers during an inbound transaction
...
### <a name="to-handle-serial-and-lot-numbers-when-getting-receipt-lines-from-a-purchase-invoice" />To handle serial and lot numbers when getting receipt lines from a purchase invoice
...
## <a name="to-assign-a-serial-or-lot-number-during-an-outbound-transaction" />To assign a serial or lot number during an outbound transaction
...
### <a name="to-select-from-existing-serial-or-lot-numbers" />To select from existing serial or lot numbers
...
### <a name="to-assign-new-serial-or-lot-numbers" />To assign new serial or lot numbers
...
### <a name="assign-tracking-numbers-on-source-documents" />Assign tracking numbers on source documents
...
## <a name="to-handle-serial-and-lot-numbers-on-transfer-orders" />To handle serial and lot numbers on transfer orders
...
## <a name="to-record-additional-serial-or-lot-number-information" />To record additional serial or lot number information
...
## <a name="to-modify-existing-serial-or-lot-number-information" />To modify existing serial or lot number information
...
## <a name="to-reclassify-serial-or-lot-numbers" />To reclassify serial or lot numbers
