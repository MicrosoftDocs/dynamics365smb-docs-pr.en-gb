...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Design Details: Reconciliation with the General Ledger
...
## <a name="post-inventory-cost-to-gl-batch-job" />Post Inventory Cost to G/L Batch Job
...
## <a name="automatic-cost-posting" />Automatic Cost Posting
...
## <a name="account-types" />Account Types
