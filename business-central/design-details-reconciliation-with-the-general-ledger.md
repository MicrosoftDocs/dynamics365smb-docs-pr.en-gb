...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger"></a><a name="design-details-reconciliation-with-the-general-ledger"></a>Design Details: Reconciliation with the General Ledger
...
## <a name="post-inventory-cost-to-gl-batch-job"></a><a name="post-inventory-cost-to-gl-batch-job"></a>Post Inventory Cost to G/L Batch Job
...
## <a name="automatic-cost-posting"></a><a name="automatic-cost-posting"></a>Automatic Cost Posting
...
## <a name="account-types"></a><a name="account-types"></a>Account Types
