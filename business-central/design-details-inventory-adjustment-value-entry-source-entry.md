...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Posting Date on Adjustment Value Entry Compared to the Source Entry
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Revaluation scenario
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>To test the scenario
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Item charge scenario
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>To test the scenario
