...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Posting Date on Adjustment Value Entry Compared to the Source Entry
...
## <a name="revaluation-scenario" />Revaluation scenario
