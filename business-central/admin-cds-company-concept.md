...
# <a name="data-ownership-models" />Data Ownership Models
...
## <a name="team-ownership" />Team Ownership
...
## <a name="choosing-a-different-business-unit" />Choosing a different business unit
...
## <a name="person-ownership" />Person Ownership
