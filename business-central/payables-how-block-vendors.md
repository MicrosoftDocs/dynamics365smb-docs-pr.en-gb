...
ms.author: bholtorf
---
# <a name="block-vendors"></a><a name="block-vendors"></a><a name="block-vendors"></a>Block Vendors
...
## <a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a>To block a vendor
