...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Pick for Production, Assembly, or Jobs in Basic Warehouse Configurations
...
## <a name="inventory-picks" />Inventory picks
...
## <a name="inventory-movements" />Inventory movements
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Pick or move for production, assembly, and jobs in a basic warehouse configuration
...
### <a name="to-create-an-inventory-pick-from-the-source-document" />To create a inventory pick from the source document
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />To create an inventory movement from the source document
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />To create multiple inventory picks or movements with a batch job
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />To create inventory picks or movements in two steps
...
## <a name="to-record-the-inventory-pick" />To record the inventory pick
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Flushing production components in a basic warehouse configuration
