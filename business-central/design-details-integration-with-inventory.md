...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory"></a><a name="design-details-integration-with-inventory"></a><a name="design-details-integration-with-inventory"></a>Design Details: Integration with Inventory
...
## <a name="physical-inventory"></a><a name="physical-inventory"></a><a name="physical-inventory"></a>Physical inventory
...
## <a name="warehouse-adjustments-to-the-item-ledger"></a><a name="warehouse-adjustments-to-the-item-ledger"></a><a name="warehouse-adjustments-to-the-item-ledger"></a>Warehouse adjustments to the item ledger
