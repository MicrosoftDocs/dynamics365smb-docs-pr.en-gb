...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Design Details: Integration with Inventory
...
## <a name="physical-inventory" />Physical inventory
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Warehouse adjustments to the item ledger
