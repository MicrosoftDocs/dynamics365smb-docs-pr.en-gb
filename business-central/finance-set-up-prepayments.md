...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />To add prepayment accounts to the general posting setup
...
## <a name="to-set-up-number-series-for-prepayment-documents" />To set up number series for prepayment documents
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />To set up prepayment percentages for items, customers, and vendors
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />To determine which prepayment percentage has first priority
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />To automatically release sales orders when prepayments are applied
