...
ms.author: soalex
---
# <a name="application-compliance" />Application Compliance
...
## <a name="data-privacy" />Data privacy
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Accounting processes and controls to aid compliance
...
## <a name="enhance-people-practices-with-technology" />Enhance people practices with technology
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Realize the benefits of an integrated business management solution
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Gain control of critical information, processes, and reports
...
### <a name="manage-compliance-to-the-standards-that-matter" />Manage compliance to the standards that matter
...
### <a name="tailor-financial-reports-to-your-needs" />Tailor financial reports to your needs
...
### <a name="improve-information-validity" />Improve information validity
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Comply quickly with discovery requests and reporting demands
...
### <a name="help-ensure-clear-audit-trails" />Help ensure clear audit trails
...
## <a name="compliance-and-local-functionality" />Compliance and local functionality
