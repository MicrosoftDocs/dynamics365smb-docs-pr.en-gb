...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>To create a reminder automatically
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>To create a reminder manually
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>To replace reminder texts
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>To issue a reminder
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>To cancel an issued reminder
