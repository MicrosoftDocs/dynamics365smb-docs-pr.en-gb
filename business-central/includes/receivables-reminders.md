...
### <a name="to-create-a-reminder-automatically" />To create a reminder automatically
...
### <a name="to-create-a-reminder-manually" />To create a reminder manually
...
### <a name="to-replace-reminder-texts" />To replace reminder texts
...
### <a name="to-issue-a-reminder" />To issue a reminder
...
### <a name="to-cancel-an-issued-reminder" />To cancel an issued reminder
