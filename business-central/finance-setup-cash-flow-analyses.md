...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Setting Up Cash Flow Analysis
...
## <a name="the-cash-cycle-and-income--expense-charts" />The Cash Cycle and Income & Expense charts
...
## <a name="set-up-the-cash-flow-chart" />Set up the Cash Flow chart
...
## <a name="set-up-cash-flow-forecasts" />Set up cash flow forecasts
...
### <a name="data-required-for-forecast" />Data required for forecast
...
#### <a name="receivables" />Receivables
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics--business-centralindex" />See related [Microsoft training](/training/modules/forecast-cash-flow-dynamics-365-business-central/index)
