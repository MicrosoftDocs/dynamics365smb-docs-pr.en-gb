...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Handling Missing Option Values
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Extending Option Sets in [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Update [!INCLUDE[prod_short](includes/cds_long_md.md)] Option Mapping
