...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Design Details: Production Order Posting
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Posting Structure
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Capacity Posting
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Production Order Costing
