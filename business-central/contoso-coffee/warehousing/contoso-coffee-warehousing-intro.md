...
# <a name="introduction-to-contoso-coffee-warehousing" />Introduction to Contoso Coffee Warehousing
...
## <a name="set-up-contoso-coffee-warehousing-data" />Set up Contoso Coffee Warehousing data
