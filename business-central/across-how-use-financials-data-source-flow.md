...
ms.locfileid: "8518474"
---
# <a name="use-prod_short-in-an-automated-workflow"></a>Use [!INCLUDE[prod_short](includes/prod_short.md)] in an Automated Workflow
...
7. From the list of available triggers, select one of the [!INCLUDE[prod_short](includes/prod_short.md)] triggers available:  
    ...
    - *When a supplier approval is requested*  
...
11. From the list of available templates, select one of the templates, and then choose **Create**.  
    ...
    - *Request Approval for Microsoft [!INCLUDE[prod_long](includes/prod_long.md)] supplier*
