...
---
# <a name="using-includeprodshortincludesprodshortmd-in-an-automated-workflow"></a>Using [!INCLUDE[prodshort](includes/prodshort.md)] in an Automated Workflow
...
## <a name="to-add-includeprodshortincludesprodshortmd-as-a-data-source-in-power-automate"></a>To add [!INCLUDE[prodshort](includes/prodshort.md)] as a data source in Power Automate
