...
ms.author: edupont
---
# <a name="about-item-types"></a><a name="about-item-types"></a><a name="about-item-types"></a>About Item Types
...
## <a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a><a name="costing-methods-for-types-of-items"></a>Costing Methods for Types of Items
...
## <a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a><a name="catalog-and-service-items"></a>Catalogue and Service Items
