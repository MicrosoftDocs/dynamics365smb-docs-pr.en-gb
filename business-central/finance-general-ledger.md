...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Understanding the General Ledger and Chart of Accounts
...
## <a name="general-ledger-setup-and-general-posting-setup" />General ledger setup and general posting setup
...
## <a name="the-chart-of-accounts" />The chart of accounts
...
## <a name="account-categories" />Account categories
...
## <a name="get-a-quick-overview" />Get a quick overview
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Access to create and edit accounts and account categories
...
## <a name="see-related-microsoft-trainingtrainingmodulesbusiness-central-configure-general-ledger-setup" />See related [Microsoft training](/training/modules/business-central-configure-general-ledger-setup/)
