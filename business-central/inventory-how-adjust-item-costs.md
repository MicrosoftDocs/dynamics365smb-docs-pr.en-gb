...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Adjust Item Costs
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>To adjust item costs manually
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>To make general changes in the direct unit cost
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Understanding Unit Cost Calculation
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Unit Cost Calculation for Purchases
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Costing Method FIFO, LIFO, Specific, or Average
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a>Costing Method Standard
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a>All Costing Methods
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Unit Cost Calculation for Sales
