...
# <a name="validate-vat-registration-numbers"></a><a name="validate-vat-registration-numbers"></a>Validate VAT Registration Numbers
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a><a name="configure-the-service-to-verify-vat-registration-numbers-automatically"></a>Configure the service to verify VAT registration numbers automatically
...
## <a name="validation-templates"></a><a name="validation-templates"></a>Validation templates
