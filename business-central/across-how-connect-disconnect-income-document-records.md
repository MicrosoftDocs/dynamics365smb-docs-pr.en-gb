...
ms.author: edupont
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries" />Create Incoming Document Records Directly from Documents and Entries
...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice" />To create and connect an incoming document record from a purchase invoice
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" />To create and connect an incoming document record from a vendor ledger entry
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />To remove a connection from an incoming document record to a posted document
