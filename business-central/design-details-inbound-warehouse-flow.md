...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Design Details: Inbound Warehouse Flow
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>No dedicated warehouse activity
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Basic warehouse configurations
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1: Release a source document to create a request for an inventory put-away
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Create an inventory put-away
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Post an inventory put-away
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Release the source document
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Create a warehouse receipt
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3: Post the warehouse receipt
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (Optional) Generate put-away worksheet lines
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5: Create a warehouse put-away document
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Register a warehouse put-away
...
## <a name="related-tasks"></a><a name="related-tasks"></a>Related tasks
