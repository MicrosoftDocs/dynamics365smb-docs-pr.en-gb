...
ms.author: edupont
---
# <a name="use-item-charges-to-account-for-additional-trade-costs" />Use Item Charges to Account for Additional Trade Costs
...
## <a name="to-set-up-item-charge-numbers" />To set up item charge numbers
...
## <a name="to-assign-an-item-charge-directly-to-the-purchase-invoice-for-the-item" />To assign an item charge directly to the purchase invoice for the item
...
## <a name="to-assign-an-item-charge-from-a-separate-invoice-to-the-purchase-invoice-for-the-item" />To assign an item charge from a separate invoice to the purchase invoice for the item
...
## <a name="handle-item-charges-for-partial-receipts" />Handle item charges for partial receipts
...
## <a name="see-related-microsoft-trainingtrainingmodulespost-purchase-item-charges-dynamics--business-central" />See related [Microsoft training](/training/modules/post-purchase-item-charges-dynamics-365-business-central/)
