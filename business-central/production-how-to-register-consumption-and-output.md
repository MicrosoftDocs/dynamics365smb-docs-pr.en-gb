...
ms.author: edupont
---
# <a name="register-consumption-and-output-for-one-released-production-order-line" />Register Consumption and Output for One Released production order line
...
## <a name="to-register-consumption-and-output" />To register consumption and output
