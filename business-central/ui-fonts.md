...
ms.author: edupont
---
# <a name="available-fonts" />Available Fonts
...
## <a name="document-fonts" />Document Fonts
...
## <a name="fonts-for-checks" />Fonts for Cheques
...
## <a name="fonts-for-barcodes" />Fonts for Barcodes
