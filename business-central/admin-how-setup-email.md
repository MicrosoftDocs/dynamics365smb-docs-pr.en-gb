...
# <a name="set-up-email" />Set Up Email
...
## <a name="adding-email-accounts" />Adding Email Accounts
...
## <a name="add-email-accounts" />Add Email Accounts
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Assign email scenarios to email accounts
...
## <a name="set-up-view-policies" />Set up view policies
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Specify how many messages an account can send per minute
...
## <a name="set-up-reusable-email-texts-and-layouts" />Set up reusable email texts and layouts
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Use a substitute sender address on outbound email messages
...
## <a name="set-up-document-sending-profiles" />Set up document sending profiles
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Optional: Set up email logging in Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Setting up email for Business Central on-premises
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Create an app registration for Business Central in Azure portal
