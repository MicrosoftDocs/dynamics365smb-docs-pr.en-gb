...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Convert Existing Locations to Warehouse Locations
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />To enable an existing location to operate as a warehouse location
