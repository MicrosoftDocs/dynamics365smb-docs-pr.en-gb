...
---
# <a name="set-up-intrastat-reporting" />Set up Intrastat reporting
...
## <a name="enable-the-new-intrastat-experience" />Enable the new Intrastat experience
...
## <a name="intrastat-configuration" />Intrastat configuration

Before you can use Intrastat reports, there are several configurations that must be set up.

### <a name="intrastat-reporting-setup" />Intrastat reporting setup
...
### <a name="set-mandatory-fields-with-the-intrastat-report-checklist" />Set mandatory fields with the Intrastat report checklist
...
## <a name="use-custom-codeunits-in-intrastat-reporting" />Use custom codeunits in Intrastat reporting
...
## <a name="other-intrastat-configurations" />Other Intrastat configurations
...
#### <a name="set-up-transport-methods" />Set up transport methods
...
#### <a name="set-up-transaction-nature-codes" />Set up transaction nature codes
...
#### <a name="set-up-fixed-assets-for-intrastat" />Set up fixed assets for Intrastat
...
#### <a name="set-up-vendors-for-intrastat" />Set up vendors for Intrastat
...
#### <a name="set-up-customers-for-intrastat" />Set up customers for Intrastat
...
#### <a name="exclude-items-and-fixed-assets-from-intrastat-reporting" />Exclude items and fixed assets from Intrastat reporting

If there's a reason to exclude a specific item or fixed asset from Intrastat reporting, change the option on its card.

##### <a name="exclude-an-item-from-intrastat-reporting" />Exclude an item from Intrastat reporting
...
##### <a name="exclude-a-fixed-asset-from-intrastat-reporting" />Exclude a fixed asset from Intrastat reporting

1. Select the ![Lightbulb that opens the Tell Me feature.](media/ui-search/search_small.png "Tell me what you want to do") icon, enter **Fixed Assets**, and then select the related link.
2. Select the fixed asset you want to configure.
3. On the **Intrastat** FastTab, select the **Exclude from Intrastat Report** checkbox.

#### <a name="set-up-tariff-numbers" />Set up commodity codes
...
## <a name="enter-country-specific-intrastat-settings" />Enter country-specific Intrastat settings
...
### <a name="czech-republic" />Czech Republic
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesprocess-intrastat-dynamics-365-business-centralindex" />See related training at [Microsoft Learn](/learn/modules/process-intrastat-dynamics-365-business-central/index).
