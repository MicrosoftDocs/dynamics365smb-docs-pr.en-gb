...
## <a name="create-a-report-for-a-list-page" />Create a report for a list page
...
## <a name="set-the-report-size-and-color" />Set the report size and colour
...
## <a name="reports-with-multiple-pages" />Reports with multiple pages
...
## <a name="fixing-problems" />Fixing problems
...
### <a name="you-cant-see-the-power-bi-factbox-on-a-list-page" />You can't see the Power BI FactBox on a list page
...
### <a name="you-cant-see-the-report-in-the-select-report-pane" />You can't see the report in the Select Report pane
...
### <a name="report-is-loaded-but-blank-not-filtered-or-filtered-incorrectly" />Report is loaded but blank, not filtered, or filtered incorrectly
...
### <a name="report-is-loaded-but-it-shows-a-page-you-didnt-expect" />Report is loaded, but it shows a page you didn't expect

Verify that the page you want displayed is the first page in your report.  

### <a name="report-appears-with-an-unwanted-gray-boarder-or-its-too-small-or-too-large" />Report appears with an unwanted grey border, or it's too small or too large
