...
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-"></a>Creating Power BI reports for displaying list data in [!INCLUDE[prod_short](includes/prod_short.md)]
