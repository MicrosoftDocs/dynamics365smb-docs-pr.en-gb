...
### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />To request a inventory pick by releasing the source document
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />To create a inventory pick based on the source document
