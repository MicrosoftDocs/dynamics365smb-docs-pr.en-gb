...
You can create a inventory pick in three ways:  

- Create the pick in two steps by first requesting a inventory pick by releasing the source document. This signals to the warehouse that the source document is ready for picking. The inventory pick can then be created on the **Inventory Pick** page based on the source document.  
...
## <a name="to-request-an-inventory-pick-by-releasing-the-source-document"></a>To request a inventory pick by releasing the source document
...
## <a name="to-create-an-inventory-pick-based-on-the-source-document"></a>To create a inventory pick based on the source document
