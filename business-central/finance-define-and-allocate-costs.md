...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Defining and Allocating Costs
...
## <a name="setting-up-allocation-source-and-targets" />Setting Up Allocation Source and Targets
...
### <a name="to-set-up-cost-allocations" />To set up cost allocations
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Setting Filters for Dynamic Allocation Bases
...
### <a name="setting-filters" />Setting Filters
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />To define the allocation source PROD cost centre on the General FastTab
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />To define the allocation target cost objects on the Lines FastTab
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />To define dynamic allocations based on items sold in the previous year
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/modules/allocate-costs-dynamics-365-business-central/)
