...
ms.author: edupont
---
# <a name="setting-up-purchasing" />Setting Up Purchasing
...
## <a name="purchases-and-payables-setup" />Purchases and payables setup
...
### <a name="general-settings" />General settings
...
### <a name="number-series-settings" />Number series settings
...
## <a name="exact-cost-reversing" />Exact cost reversing
...
## <a name="more-purchasing-setups" />More purchasing setups
...
## <a name="see-related-training-at-microsoft-learnlearnpathstrade-get-started-dynamics--business-central" />See related training at [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
