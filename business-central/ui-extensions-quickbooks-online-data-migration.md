...
# <a name="the-quickbooks-online-data-migration-extension" />The QuickBooks Online Data Migration Extension
...
## <a name="what-data-can-i-import-from-quickbooks-online" />What data can I import from QuickBooks Online?
...
## <a name="how-do-i-start-using-the-extension" />How do I start using the extension?
...
## <a name="see-related-microsoft-trainingtrainingmodulesmigrate-data-dynamics-365-business-central" />See related [Microsoft training](/training/modules/migrate-data-dynamics-365-business-central/)
