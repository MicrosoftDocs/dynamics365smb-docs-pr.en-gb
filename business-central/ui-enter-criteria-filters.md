...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a><a name="sorting-searching-and-filtering"></a>Sorting, Searching, and Filtering
...
## <a name="sorting"></a><a name="sorting"></a><a name="sorting"></a>Sorting
...
## <a name="searching"></a><a name="searching"></a><a name="searching"></a>Searching
...
### <a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a><a name="fine-tuning-the-search-with-filter-criteria"></a>Fine-tuning the Search with Filter criteria
...
## <a name="filtering"></a><a name="filtering"></a><a name="filtering"></a><a name="filtering"></a>Filtering
...
### <a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a><a name="filtering-with-option-fields"></a>Filtering with Option Fields
...
### <a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a><a name="setting-filters-on-lists"></a>Setting Filters on Lists
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a><a name="setting-filters-in-reports-batch-jobs-and-xmlports"></a>Setting Filters in Reports, Batch Jobs, and XMLports
...
## <a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a><a name="entering-filter-criteria"></a>Entering Filter Criteria
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="a-namefiltercriteria-afilter-criteria-and-operators"></a><a name="FilterCriteria"> </a>Filter Criteria and Operators
...
#### <a name="124-eitheror"></a><a name="124-eitheror"></a><a name="124-eitheror"></a>(&#124;) Either/or

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`1200|1300`|Numbers with 1200 or 1300|  

#### <a name="-not-equal-to"></a><a name="-not-equal-to"></a><a name="-not-equal-to"></a>(<>) Not equal to
...
#### <a name="-greater-than"></a><a name="-greater-than"></a><a name="-greater-than"></a>(>) Greater than

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`>1200`|Numbers greater than 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Greater than or equal to

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`>=1200`|Numbers greater than or equal to 1200|  

#### <a name="-less-than"></a><a name="-less-than"></a><a name="-less-than"></a>(<) Less than

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`<1200`|Numbers less than 1200|  

#### <a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a><a name="-less-than-or-equal-to"></a>(<=) Less than or equal to

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`<=1200`|Numbers less than or equal to 1200|  

#### <a name="-and"></a><a name="-and"></a><a name="-and"></a>(&) And

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`>200&<1200`|Numbers greater than 200 and less than 1200|  

#### <a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a><a name="-an-exact-character-match"></a>('') An exact character match
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Case insensitive

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`@man*`|Text that starts with **man** and is case insensitive.|  

#### <a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a><a name="-an-indefinite-number-of-unknown-characters"></a>(*) An indefinite number of unknown characters
...
#### <a name="-one-unknown-character"></a><a name="-one-unknown-character"></a><a name="-one-unknown-character"></a>(?) One unknown character

|Sample Expression|Records Displayed|  
|-----------------------|-----------------------|  
|`Hans?n`|Text such as **Hansen** or **Hanson**|  

#### <a name="combined-format-expressions"></a><a name="combined-format-expressions"></a><a name="combined-format-expressions"></a>Combined Format Expressions
...
### <a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="filtering-on-values-that-contain-symbols"></a><a name="symbols"></a>Filtering on Values That Contain Symbols
...
### <a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="a-namefiltertokens-afilter-tokens"></a><a name="FilterTokens"> </a>Filter Tokens
...
#### <a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a><a name="me-or-userid-records-assigned-to-you"></a>(%me or %userid) Records Assigned to You
...
#### <a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a><a name="mycustomers-customers-in-my-customers"></a>(%mycustomers) Customers in My Customers
...
#### <a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a><a name="myitems-items-in-my-items"></a>(%myitems) Items in My Items
...
#### <a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a><a name="myvendors-vendors-in-my-vendors"></a>(%myvendors) Suppliers in My Suppliers
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/search-filter-sort-data-dynamics-365-business-central/)
