...
ms.author: edupont
---
# <a name="troubleshooting-self-service-sign-up" />Troubleshooting Self-Service Sign-Up
...
## <a name="what-email-address-can-i-use-with-business-central" />What email address can I use with Business Central?
...
## <a name="regional-availability" />Regional Availability
