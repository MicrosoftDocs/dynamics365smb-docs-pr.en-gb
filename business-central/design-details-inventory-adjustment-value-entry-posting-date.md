...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry"></a><a name="design-details-posting-date-on-adjustment-value-entry"></a>Design Details: Posting Date on Adjustment Value Entry
...
## <a name="how-posting-dates-are-assigned"></a><a name="how-posting-dates-are-assigned"></a>How posting dates are assigned
...
#### <a name="item-ledger-entry"></a><a name="item-ledger-entry"></a>Item Ledger Entry
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job"></a><a name="common-problems-with-the-adjust-cost---item-entries-batch-job"></a>Common problems with the "Adjust Cost - Item entries"-batch job
