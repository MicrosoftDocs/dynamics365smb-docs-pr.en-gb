...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry" />Design Details: Posting Date on Adjustment Value Entry
...
## <a name="how-posting-dates-are-assigned" />How posting dates are assigned
...
#### <a name="item-ledger-entry" />Item Ledger Entry
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job" />Common problems with the "Adjust Cost - Item entries"-batch job
...
### <a name="posting-date-on-adjustment-value-entry-versus-posting-date-on-entry-causing-the-adjustment-such-as-revaluation-or-item-charge" />Posting Date on Adjustment Value Entry versus Posting Date on entry causing the adjustment such as Revaluation or Item charge
