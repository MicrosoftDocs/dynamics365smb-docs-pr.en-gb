...
> [!NOTE]
> When you use this web service, closing dates are not included in your data set. You can then use filters in Power BI to analyse various time periods.
