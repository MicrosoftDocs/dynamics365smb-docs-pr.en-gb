...
Countries/regions have different requirements for including tax in prices. If you want prices to automatically include VAT, you can turn on [Dynamic VAT-inclusive pricing](https://help.shopify.com/en/manual/markets/pricing/dynamic-tax-inclusive-pricing) in Shopify.
...
### <a name="all-prices-include-tax-is-selected-1"></a>All prices include tax is selected
...
### <a name="all-prices-include-tax-is-not-selected-1"></a>All prices include tax is not selected
