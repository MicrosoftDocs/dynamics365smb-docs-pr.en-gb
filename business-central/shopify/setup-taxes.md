...
# <a name="set-up-taxes-for-the-shopify-connection"></a><a name="set-up-taxes-for-the-shopify-connection"></a>Set Up Taxes for the Shopify Connection
...
## <a name="if-you-sell-domestically"></a><a name="if-you-sell-domestically"></a>If you sell domestically
...
In markets such as these, a price of 100 EUR defined on the product card already contains value-added VAT (VAT). The price, including VAT, displays to the customer in the storefront and at checkout.  
...
## <a name="if-you-sell-internationally"></a><a name="if-you-sell-internationally"></a>If you sell internationally
...
### <a name="all-prices-include-tax-is-selected"></a><a name="all-prices-include-tax-is-selected"></a>All prices include tax is selected
...
### <a name="all-prices-include-tax-is-not-selected"></a><a name="all-prices-include-tax-is-not-selected"></a>All prices include tax is not selected
...
## <a name="dynamic-tax-inclusive-pricing"></a><a name="dynamic-tax-inclusive-pricing"></a>Dynamic tax-inclusive pricing
...
### <a name="all-prices-include-tax-is-selected-1"></a><a name="all-prices-include-tax-is-selected-1"></a>All prices include tax is selected
...
### <a name="all-prices-include-tax-is-not-selected-1"></a><a name="all-prices-include-tax-is-not-selected-1"></a>All prices include tax is not selected
...
## <a name="if-you-sell-to-eu-customers"></a><a name="if-you-sell-to-eu-customers"></a>If you sell to EU customers
...
### <a name="collect-vat-set-to-one-stop-shop-registration"></a><a name="collect-vat-set-to-one-stop-shop-registration"></a>Collect VAT set to one-stop shop registration
...
### <a name="collect-vat-set-to-micro-business-exemption"></a><a name="collect-vat-set-to-micro-business-exemption"></a>Collect VAT set to micro-business exemption
...
Shopify uses the domestic VAT rate and ignores the VAT rate in the foreign country when it calculates final prices.

## <a name="importing-shopify-orders-sold-to-international-customers"></a><a name="importing-shopify-orders-sold-to-international-customers"></a>Importing Shopify orders sold to international customers
...
## <a name="other-tax-remarks"></a><a name="other-tax-remarks"></a>Other tax remarks
