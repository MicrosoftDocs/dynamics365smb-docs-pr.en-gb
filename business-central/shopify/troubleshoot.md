...
Now, when the sync action is triggered the task will run in the foreground and if an error occurs, you'll get an error dialogue with **Copy details** link. Use this link to copy additional information to a text editor for the further analysis.
