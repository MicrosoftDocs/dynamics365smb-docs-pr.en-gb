...
ms.author: edupont
---
# <a name="invoice-sales" />Invoice Sales
...
## <a name="create-sales-invoices" />Create sales invoices
...
### <a name="to-create-a-sales-invoice" />To create a sales invoice
...
## <a name="registering-payments" />Registering payments
...
## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics--business-centralindex" />See related [Microsoft training](/training/modules/invoicing-customers-dynamics-365-business-central/index).
