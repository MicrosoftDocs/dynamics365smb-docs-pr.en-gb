...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Walkthrough: Planning Supplies Automatically
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>To create stockkeeping units
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>To change selected planning parameters
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Creating a Regenerative Supply Plan
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>To create the sales order
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>To create a regenerative plan to fulfill demand at location EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>To calculate MRP to include underlying component needs
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Analyzing the Planning Result
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>To view order tracking entries for item 1300
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>To check the planning parameter
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>To view more order tracking entries
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Carrying Out Action Messages
 Next, Eduardo converts the suggested planning lines to supply orders by using the **Carry Out Action Msg.** function.  

### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>To automatically create the suggested supply orders
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Creating a Net Change Plan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>To create the new sales demand and replan accordingly
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Analysing the Changed Planning Result
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>To view order tracking entries for item 1250
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>To view an existing order
