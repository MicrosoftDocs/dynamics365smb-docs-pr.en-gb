...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Walkthrough: Planning Supplies Automatically
...
### <a name="to-create-stockkeeping-units" />To create stockkeeping units
...
### <a name="to-change-selected-planning-parameters" />To change selected planning parameters
...
## <a name="creating-a-regenerative-supply-plan" />Creating a Regenerative Supply Plan
...
### <a name="to-create-the-sales-order" />To create the sales order
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />To create a regenerative plan to fulfill demand at location EAST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />To calculate MRP to include underlying component needs
...
## <a name="analyzing-the-planning-result" />Analyzing the Planning Result
...
### <a name="to-check-the-planning-parameter" />To check the planning parameter
...
### <a name="to-view-more-order-tracking-entries" />To view more order tracking entries
...
## <a name="carrying-out-action-messages" />Carrying Out Action Messages
 Next, Eduardo converts the suggested planning lines to supply orders by using the **Carry Out Action Msg.** function.  

### <a name="to-automatically-create-the-suggested-supply-orders" />To automatically create the suggested supply orders
...
## <a name="creating-a-net-change-plan" />Creating a Net Change Plan
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />To create the new sales demand and replan accordingly
...
## <a name="analyzing-the-changed-planning-result" />Analysing the Changed Planning Result
...
### <a name="to-view-an-existing-order" />To view an existing order
