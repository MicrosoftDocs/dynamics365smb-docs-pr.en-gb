...
ms.author: edupont
---
# <a name="view-the-availability-of-items" />View the Availability of Items
...
## <a name="to-view-the-availability-of-an-item-according-to-when-it-will-be-received-or-shipped" />To view the availability of an item according to when it will be received or shipped
...
## <a name="to-view-the-availability-of-an-item-in-different-periods" />To view the availability of an item in different periods
...
## <a name="to-view-the-availability-of-an-item-at-the-locations-where-it-is-stored" />To view the availability of an item at the locations where it is stored
...
## <a name="to-view-the-availability-of-all-items-by-the-location-where-they-are-stored" />To view the availability of all items by the location where they are stored
...
## <a name="to-view-the-availability-of-an-item-by-its-use-in-assembly-or-production-boms" />To view the availability of an item by its use in assembly or production BOMs
...
### <a name="to-view-the-availability-of-an-item-according-to-demand-for-its-parent" />To view the availability of an item according to demand for its parent
...
## <a name="to-view-the-availability-of-an-item-by-its-units-of-measure" />To view the availability of an item by its units of measurement
...
## <a name="to-view-the-availability-of-an-item-by-its-variants" />To view the availability of an item by its variants
...
## <a name="assembly-availability-page" />Assembly Availability Page
