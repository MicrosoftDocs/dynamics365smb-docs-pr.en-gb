...
---
# <a name="create-production-orders-from-sales-orders" />Create Production Orders from Sales Orders

You can create production orders for produced items directly from sales orders.  

## <a name="to-create-a-production-order-from-a-sales-order" />To create a production order from a sales order
