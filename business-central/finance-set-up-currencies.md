...
ms.author: edupont
---
# <a name="set-up-currencies" />Set Up Currencies
...
## <a name="a-namecurracurrencies" /><a name="curr"></a>Currencies
...
### <a name="available-currency-functions" />Available currency functions
...
## <a name="lcy-and-other-currencies" />LCY and other currencies

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Rounding currencies
...
### <a name="unit-amount-rounding" />Unit-amount rounding
...
### <a name="amount-rounding" />Amount rounding
...
## <a name="exchange-rates" />Exchange rates
...
## <a name="general-ledger-accounts" />General ledger accounts
...
## <a name="example-of-a-receivable-currency-transaction" />Example of a receivable currency transaction

[!INCLUDE [finance-currencies-example](includes/finance-currencies-example.md)]

## <a name="see-related-microsoft-trainingtrainingmodulescurrencies-exchange-rates-dynamics-365-business-central" />See related [Microsoft training](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
