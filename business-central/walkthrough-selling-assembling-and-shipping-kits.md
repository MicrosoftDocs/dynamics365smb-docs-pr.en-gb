...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits" />Walkthrough: Selling, Assembling, and Shipping Kits
...
### <a name="setting-up-assembly-items" />Setting up Assembly Items
...
### <a name="selling-customized-assembly-items" />Selling Customised Assembly Items
...
### <a name="planning-for-assembly-items" />Planning for Assembly Items
...
### <a name="assembling-items" />Assembling Items
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order" />Shipping Assembly Items, from Stock and Assembled to Order
...
## <a name="prepare-sample-data" />Prepare Sample Data
...
### <a name="creating-the-assembly-items" />Creating the Assembly Items
...
### <a name="selling-the-assembly-items" />Selling the Assembly Items
...
### <a name="planning-for-the-unavailable-ats-items" />Planning for the Unavailable ATS Items
...
### <a name="assembling-and-shipping-the-first-ato-quantity" />Assembling and Shipping the First ATO Quantity
...
### <a name="assembling-and-recording-the-second-ato-quantity" />Assembling and Recording the Second ATO Quantity
...
### <a name="assembling-the-ats-quantity" />Assembling the ATS Quantity
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order" />Shipping the Remaining Items, Partly from Stock and Partly Assembled to the Order
