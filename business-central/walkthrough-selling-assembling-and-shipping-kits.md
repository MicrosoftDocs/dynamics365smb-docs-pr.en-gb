...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Walkthrough: Selling, Assembling, and Shipping Kits
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Setting up Assembly Items
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Selling Customised Assembly Items
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Planning for Assembly Items
...
### <a name="assembling-items"></a><a name="assembling-items"></a><a name="assembling-items"></a>Assembling Items
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Shipping Assembly Items, from Stock and Assembled to Order
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Prepare Sample Data
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Creating the Assembly Items
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Selling the Assembly Items
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planning for the Unavailable ATS Items
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Assembling and Shipping the First ATO Quantity
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Assembling and Recording the Second ATO Quantity
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Assembling the ATS Quantity
