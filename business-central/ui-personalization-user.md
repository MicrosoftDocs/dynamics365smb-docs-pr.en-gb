...
When personalising a page, you use **Add field to page** pane to show fields that are currently hidden on the page. To open this pane, select the **+ Field** action near the top of the page. Unlike other hidden elements, hidden fields aren't indicated on the page itself in personalisation mode. However, you can identify hidden fields by using the **Add field to page** pane.
...
### <a name="add-a-field-so-its-visible-on-the-page"></a>Make a hidden field visible
