...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Personalise Your Workspace
...
## <a name="to-change-the-width-of-a-column" />To change the width of a column
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />To start personalising a page through the **Personalising** banner
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />To remove, hide, and show actions and action groups
...
### <a name="to-move-actions-and-action-groups" />To move actions and action groups
...
## <a name="to-clear-personalization" />To clear personalisation
...
## <a name="other-points-of-interest" />Other points of interest
