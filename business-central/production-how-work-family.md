...
ms.author: edupont
---
# <a name="work-with-production-families" />Work with Production Families
...
## <a name="to-set-up-a-production-family" />To set up a production family
...
## <a name="to-produce-based-on-a-production-family" />To produce based on a production family
