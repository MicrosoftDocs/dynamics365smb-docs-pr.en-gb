...
ms.author: edupont
---
# <a name="work-with-production-families"></a><a name="work-with-production-families"></a><a name="work-with-production-families"></a>Work with Production Families
...
## <a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a>To set up a production family
...
## <a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a>To produce based on a production family
