...
ms.author: edupont
---
# <a name="use-time-sheets" />Use Time Sheets
...
## <a name="to-create-time-sheets" />To create time sheets
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />To reuse time sheet lines in other time sheets
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />To copy job planning lines to a time sheet
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />To define work types and add one to a time sheet
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />To fill in time sheet lines and submit for approval
...
## <a name="to-approve-or-reject-a-time-sheet" />To approve or reject a time sheet
...
## <a name="to-reopen-a-time-sheet" />To reopen a time sheet
...
## <a name="to-view-and-approve-time-sheets-by-job" />To view and approve time sheets by job
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />To approve or reject a time sheet by job
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />To post time sheet lines in a resource journal
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />To post time sheet lines in a job journal
...
## <a name="to-archive-time-sheets" />To archive time sheets
