...
# <a name="the-c5-data-migration-extension" />The C5 Data Migration Extension
...
## <a name="what-data-is-migrated" />What data is migrated?

The following data is migrated for each entity:

### <a name="customers" />Customers
...
### <a name="chart-of-accounts" />Chart of accounts
...
## <a name="file-size-requirements" />File size requirements
...
## <a name="to-migrate-data" />To migrate data
...
## <a name="viewing-the-status-of-the-migration" />Viewing the status of the migration
...
## <a name="how-to-avoid-double-posting" />How to avoid double-posting
...
## <a name="correcting-errors" />Correcting errors
...
## <a name="verifying-data-after-migrating" />Verifying data after migrating
...
## <a name="stopping-data-migration" />Stopping data migration
