...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>The C5 Data Migration Extension
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>What data is migrated?

The following data is migrated for each entity:

### <a name="customers"></a><a name="customers"></a><a name="customers"></a>Customers
...
### <a name="vendors"></a><a name="vendors"></a><a name="vendors"></a>Vendors
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Chart of accounts
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a><a name="file-size-requirements"></a>File size requirements
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a><a name="to-migrate-data"></a>To migrate data
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Viewing the status of the migration
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>How to avoid double-posting
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a><a name="correcting-errors"></a>Correcting errors
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Verifying data after migrating
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Stopping data migration
