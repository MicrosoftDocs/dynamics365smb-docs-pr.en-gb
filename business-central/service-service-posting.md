...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a><a name="service-posting"></a>Service Posting
...
## <a name="ship"></a><a name="ship"></a><a name="ship"></a>Ship
...
## <a name="invoice"></a><a name="invoice"></a><a name="invoice"></a>Invoice
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Ship and Invoice
The ship and invoice option lets you issue both a service shipment and an invoice at the same time.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a><a name="ship-and-consume"></a>Ship and Consume
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>To view information about a posted service document
