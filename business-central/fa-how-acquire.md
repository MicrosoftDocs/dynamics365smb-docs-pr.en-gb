...
ms.author: edupont
---
# <a name="acquire-fixed-assets" />Acquire Fixed Assets
...
## <a name="to-create-a-fixed-asset-and-acquire-it-automatically" />To create a fixed asset and acquire it automatically
...
## <a name="to-set-up-a-component-list-for-a-main-asset" />To set up a component list for a main asset
...
## <a name="to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal" />To post a fixed asset acquisition manually with the fixed asset G/L journal
...
## <a name="to-cancel-an-acquisition-cost-posting-for-one-fixed-asset" />To cancel an acquisition cost posting for one fixed asset
...
## <a name="to-post-the-salvage-value-together-with-the-acquisition-cost" />To post the salvage value together with the acquisition cost
...
## <a name="see-related-microsoft-trainingtrainingmodulespurchase-fixed-assets" />See related [Microsoft training](/training/modules/purchase-fixed-assets/)
