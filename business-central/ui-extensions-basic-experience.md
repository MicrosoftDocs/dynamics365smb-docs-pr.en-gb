...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>The Basic Experience Extension
...
## <a name="whats-available"></a><a name="whats-available"></a>What's available
...
## <a name="getting-started"></a><a name="getting-started"></a>Getting started
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Migrating data
