...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Move Items in Advanced Warehouse Configurations That Use Directed Put-away and Pick
...
## <a name="warehouse-movement-worksheet" />Warehouse movement worksheet

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />To move items with the warehouse movement worksheet
...
### <a name="to-register-the-warehouse-movement" />To register the warehouse movement
...
## <a name="internal-pick" />Internal pick

### <a name="to-create-an-internal-pick" />To create an internal pick
...
### <a name="to-register-the-warehouse-pick" />To register the warehouse pick
...
## <a name="internal-put-away" />Internal put-away

### <a name="to-create-an-internal-put-away" />To create an internal put-away
...
### <a name="to-register-the-warehouse-put-away" />To register the warehouse put away
...
## <a name="to-register-a-movement-that-has-already-happened" />To register a movement that has already happened
