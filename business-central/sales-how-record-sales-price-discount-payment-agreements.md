...
ms.locfileid: "7865553"
---
# <a name="record-sales-prices-and-discounts"></a>Record Sales Prices and Discounts
> [!NOTE]
...
| --- | --- |
| **Sales Line Discount** |An amount that is used on sales lines if a certain combination of customer, item, minimum quantity, unit of measurement, or starting and ending dates exists. These combinations work in the same way as for sales prices. |
...
* **Suggest Item Price on Wksh.** suggests changes by applying an adjustment factor to existing unit prices on item cards, or by suggesting prices for new combinations of currency, units of measurement, and so on. The unit prices on items are not changed.    
