...
# <a name="record-special-sales-prices-and-discounts" />Record Special Sales Prices and Discounts
...
## <a name="to-set-up-a-sales-price-for-a-customer" />To set up a sales price for a customer
...
## <a name="using-sales-and-purchase-price-lists" />Using sales and purchase price lists
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Converting existing prices when you turn on the pricing feature update
...
### <a name="editing-active-price-lists" />Editing active price lists
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Create sales price lines based on the unit price
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Create sales price lines based on existing price lists
...
## <a name="to-copy-sales-prices" />To copy sales prices
...
## <a name="to-bulk-update-item-prices" />To bulk update item prices
...
## <a name="best-price-calculation" />Best price calculation
...
## <a name="sales-invoice-discounts-and-service-charges" />Sales invoice discounts and service charges
...
### <a name="calculating-invoice-discounts-on-sales" />Calculating invoice discounts on sales

[!INCLUDE [sales-invoice-discounts](includes/sales-invoice-discounts.md)]

## <a name="to-set-up-a-sales-line-discount-for-a-customer" />To set up a sales line discount for a customer
...
## <a name="to-set-up-an-invoice-discount-for-a-customer" />To set up an invoice discount for a customer
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />See related [Microsoft training](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
