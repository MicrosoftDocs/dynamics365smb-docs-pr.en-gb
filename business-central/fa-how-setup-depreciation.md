...
# <a name="set-up-fixed-asset-depreciation" />Set Up Fixed Asset Depreciation
...
## <a name="to-create-a-depreciation-book" />To create a depreciation book
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />To assign a depreciation book to a fixed asset
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />To assign a depreciation book to multiple fixed assets with a batch job
...
## <a name="to-set-up-depreciation-posting-types" />To set up depreciation posting types
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />To set up default templates and batches for fixed asset depreciation
...
## <a name="fiscal-year-365-days-field-depreciation" />Fiscal Year 365 Days Field Depreciation
