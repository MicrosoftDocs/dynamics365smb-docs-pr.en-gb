...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Design Details: Transfers in Planning
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Why is a transfer a special case?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Transfers are dependent demand
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a>Planning sequence
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a>Transfer level code
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Planning transfers without SKU
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Changing quantity with reservations
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Changing quantity in a transfer chain
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Lead time calculation
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a>Safety lead time
...
## <a name="reschedule"></a><a name="reschedule"></a>Reschedule
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Serial and lot numbers in transfer chains
