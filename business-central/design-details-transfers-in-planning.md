...
---
# <a name="design-details-transfers-in-planning" />Design Details: Transfers in Planning
...
## <a name="why-is-a-transfer-a-special-case" />Why is a transfer a special case?
...
## <a name="transfers-are-dependent-demand" />Transfers are dependent demand
...
## <a name="planning-sequence" />Planning sequence
...
## <a name="transfer-level-code" />Transfer level code
...
## <a name="planning-transfers-without-sku" />Planning transfers without SKU
...
## <a name="changing-quantity-with-reservations" />Changing quantity with reservations
...
## <a name="changing-quantity-in-a-transfer-chain" />Changing quantity in a transfer chain
...
## <a name="safety-lead-time" />Safety lead time
...
## <a name="serial-and-lot-numbers-in-transfer-chains" />Serial and lot numbers in transfer chains
