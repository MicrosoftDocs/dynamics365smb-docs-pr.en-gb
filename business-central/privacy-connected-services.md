...
ms.reviewer: jswymer
---
# <a name="trial-features-that-connect-to-other-microsoft-services"></a><a name="trial-features-that-connect-to-other-microsoft-services"></a>Trial features that connect to other Microsoft services
