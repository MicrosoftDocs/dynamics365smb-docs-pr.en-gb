...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>The VAT Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Forming a VAT group
...
### <a name="license-requirements"></a><a name="license-requirements"></a>Licence requirements
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Set up a VAT group
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory setup for group members
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a>Group API setup
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Set up VAT group members
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>VAT group representative uses Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>VAT group representative uses Business Central on-premises
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Set up the VAT group representative
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Use the VAT group management features
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Review VAT member submissions
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Create a group VAT return
