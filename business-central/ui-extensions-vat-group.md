...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />The VAT Group Management Extension for the United Kingdom
...
## <a name="forming-a-vat-group" />Forming a VAT group
...
### <a name="license-requirements" />Licence requirements
...
## <a name="set-up-a-vat-group" />Set up a VAT group
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory setup for group members
...
### <a name="group-api-setup" />Group API setup
...
## <a name="set-up-vat-group-members" />Set up VAT group members
...
### <a name="vat-group-representative-uses-business-central-online" />VAT group representative uses Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />VAT group representative uses Business Central on-premises
...
## <a name="set-up-the-vat-group-representative" />Set up the VAT group representative
...
## <a name="use-the-vat-group-management-features" />Use the VAT group management features
...
### <a name="review-vat-member-submissions" />Review VAT member submissions
...
### <a name="create-a-group-vat-return" />Create a group VAT return
