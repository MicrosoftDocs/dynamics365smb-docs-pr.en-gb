...
ms.locfileid: "9529576"
---
# <a name="working-with-excel-layouts"></a>Working with Excel Layouts

Excel report layouts are based on Microsoft Excel workbooks (.xlsx files). They let you create reports by using familiar Excel features for summarising, analysing, and presenting data, like formulas, PivotTables and PivotCharts.
...
### <a name="from-another-excel-layout-on-a-report"></a>[From another Excel layout on a report](#tab/other-layout)
...
To summarise what you can and can't do on the **Data** sheet:
