...
description: From a sales invoice, to purchase products, you can create a purchase invoice for a supplier or supplier.
author: SorenGP
...
|--------|-----------|
|**Create Purchase Orders**|From a sales order, this function creates a purchase order for each supplier of items on the sales order. You can edit the purchase quantity before you create the purchase orders. Only unavailable sales quantities are suggested.
|**Create Purchase Invoice**|From a sales order and from a sales invoice, this function creates a purchase invoice for a selected supplier for all lines or selected lines on the sales document. The full sales quantity is suggested.|
...
5. Choose the **OK** button.
    ...
    A purchase order is created for each supplier of items on the sales order, including any quantity changes that you made on the **Create Purchase Orders** page.
...
To create a single purchase invoice for one or more lines on a sales document by first selecting which supplier to buy from, you use the **Create Purchase Invoice** function.
...
6. In the list of suppliers that appears, select the supplier that you want to buy all the items from, and then choose the **OK** button.
