...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Process Purchase Returns or Cancellations
...
## <a name="inventory-costing" />Inventory Costing
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />To create a purchase credit memo from a posted purchase invoice
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />To create a purchase credit memo by copying a posted purchase invoice
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />To create a purchase return order based on one or more posted purchase documents
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />To create a replacement purchase order from a purchase return order
...
## <a name="to-create-a-purchase-allowance" />To create a purchase allowance
...
## <a name="to-combine-return-shipments" />To combine return shipments
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />To remove open purchase return orders after combined return shipment posting
...
## <a name="see-related-microsoft-training" />See related [Microsoft training](/training/paths/return-items-dynamics-365-business-central/)
