...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />General Journal Post Line Overview
...
## <a name="old-architecture" />Old Architecture
...
### <a name="new-architecture" />New Architecture
