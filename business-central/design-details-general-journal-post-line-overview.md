...
description: This topic introduces changes to Codeunit 12, Gen. Jnl.-Post Line, and is the only place to insert general ledger, VAT, and customer and supplier ledger entries.
author: SorenGP
ms.topic: overview
ms.devlang: na
ms.tgt_pltfrm: na
