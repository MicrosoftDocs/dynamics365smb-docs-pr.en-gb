...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>General Journal Post Line Overview
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Old Architecture
...
### <a name="new-architecture"></a><a name="new-architecture"></a>New Architecture
