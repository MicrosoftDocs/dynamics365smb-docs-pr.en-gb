...
ms.author: jswymer
---
# <a name="entering-data" />Entering Data
...
## <a name="work-with-editable-fields" />Work with editable fields
...
### <a name="modifying-a-field-value" />Modifying a field value
...
## <a name="keyboard-shortcuts" />Keyboard Shortcuts
...
### <a name="how-quick-entry-works" />How Quick Entry Works
...
#### <a name="tips-and-tricks" />Tips and Tricks
...
### <a name="to-change-quick-entry-fields" />To change Quick Entry fields
...
## <a name="mandatory-fields" />Mandatory Fields
...
## <a name="finding-data-as-you-type" />Finding Data As You Type
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Copying and Pasting FAQ Fields and Lines
...
## <a name="filtering-line-items" />Filtering Line Items
...
### <a name="switching-the-focus-on-and-off" />Switching the Focus On and Off
...
## <a name="multitasking-across-multiple-pages" />Multitasking Across Multiple Pages
...
## <a name="entering-quantities-by-calculation" />Entering Quantities by Calculation
...
## <a name="entering-negative-numbers" />Entering Negative Numbers
...
## <a name="entering-dates-and-times" />Entering Dates and Times
...
### <a name="entering-dates" />Entering Dates
...
## <a name="entering-times" />Entering Times
...
## <a name="entering-combined-datetimes" />Entering Combined Datetimes

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration" />Entering Duration
