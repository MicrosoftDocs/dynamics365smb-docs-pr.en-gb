...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a><a name="entering-data"></a>Entering Data
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Work with editable fields
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Modifying a field value
...
## <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Keyboard Shortcuts
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Accelerating Data Entry Using Quick Entry
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>How Quick Entry Works
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Tips and Tricks
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>To change Quick Entry fields
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a><a name="mandatory-fields"></a>Mandatory Fields
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Finding Data As You Type
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Copying and Pasting FAQ Fields and Lines
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a><a name="filtering-line-items"></a>Filtering Line Items
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Focusing on Line Items
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Switching the Focus On and Off
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitasking Across Multiple Pages
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Entering Quantities by Calculation
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Entering Negative Numbers
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Entering Dates and Times
...
### <a name="entering-dates"></a><a name="entering-dates"></a><a name="entering-dates"></a>Entering Dates
...
## <a name="entering-times"></a><a name="entering-times"></a><a name="entering-times"></a>Entering Times
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Entering Combined Datetimes

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a><a name="entering-duration"></a>Entering Duration
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Setting the decimal separator used by numeric keyboards
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/explore-modify-info-dynamics-365-business-central/)
