...
ms.author: edupont
---
# <a name="set-up-purchasers" />Set Up Purchasers
...
## <a name="to-set-up-purchasers" />To set up purchasers
...
## <a name="to-assign-purchasers-to-vendors" />To assign purchasers to vendors
