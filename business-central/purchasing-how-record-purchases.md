...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Record Purchases with Purchase Invoices and Orders
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Record Purchases with Purchase Invoices
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Create a and post purchase invoice
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a>Posted invoices
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Purchasing non-inventory items
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>When to use purchase orders
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Receive items with a purchase order
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Receive more items than ordered
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Set up over-receipts
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Assign the over-receipt code to an item
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Over-receive an order
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a>Posting Purchases
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Viewing ledger entries
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Editing ledger entries
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/receive-invoice-dynamics-d365-business-central/index).

## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>See related [Microsoft training](/training/modules/processing-invoices-dynamics-365-business-central/index)
