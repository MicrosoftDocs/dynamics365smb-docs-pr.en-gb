...
---
# <a name="manage-the-intercompany-inbox-and-outbox"></a><a name="manage-the-intercompany-inbox-and-outbox"></a>Manage the Intercompany Inbox and Outbox
...
## <a name="organizing-the-inbox"></a><a name="organizing-the-inbox"></a>Organizing the Inbox
...
### <a name="transaction-source"></a><a name="transaction-source"></a>Transaction source
...
#### <a name="created-by-intercompany-partner"></a><a name="created-by-intercompany-partner"></a>Created by intercompany partner
...
#### <a name="returned-from-intercompany-partner"></a><a name="returned-from-intercompany-partner"></a>Returned from intercompany partner
...
## <a name="recreating-inbox-entries"></a><a name="recreating-inbox-entries"></a>Recreating inbox entries
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period"></a><a name="get-an-overview-of-intercompany-transactions-for-a-period"></a>Get an overview of intercompany transactions for a period
...
## <a name="import-intercompany-transactions-from-a-file"></a><a name="import-intercompany-transactions-from-a-file"></a>Import intercompany transactions from a file
...
## <a name="process-incoming-intercompany-transactions"></a><a name="process-incoming-intercompany-transactions"></a>Process incoming intercompany transactions
...
## <a name="to-process-outgoing-intercompany-transactions"></a><a name="to-process-outgoing-intercompany-transactions"></a>To process outgoing intercompany transactions
...
## <a name="recreate-intercompany-inbox-transactions"></a><a name="recreate-intercompany-inbox-transactions"></a>Recreate intercompany inbox transactions
