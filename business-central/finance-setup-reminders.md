...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Set Up Reminder Terms and Levels

You can use reminders to remind customers about overdue amounts. [!INCLUDE [reminder-terms](includes/reminder-terms.md)]

## <a name="reminder-terms"></a><a name="reminder-terms"></a>Reminder terms
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>To set up reminder terms
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Reminder levels
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>To set up reminder levels
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/send-reminders-dynamics-365-business-central/)
