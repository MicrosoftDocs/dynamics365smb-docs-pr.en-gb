...
### <a name="to-set-up-reminder-terms" />To set up reminder terms
...
## <a name="reminder-levels" />Reminder levels
...
### <a name="to-set-up-reminder-levels" />To set up reminder levels
...
## <a name="see-related-microsoft-trainingtrainingmodulessend-reminders-dynamics--business-central" />See related [Microsoft training](/training/modules/send-reminders-dynamics-365-business-central/)
