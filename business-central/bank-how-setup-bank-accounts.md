...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>To set up bank accounts
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>To enter an opening balance
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>To set up your bank account for import or export of bank files
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>To set up vendor bank accounts for export of bank files
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Changing your bank account
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>See related [Microsoft training](/training/modules/cash-management-dynamics-365-business-central/)
