...
ms.author: edupont
---
# <a name="print-vat-audit-reports-in-the-british-version" />Print VAT Audit Reports in the British Version
...
## <a name="to-print-the-vat-audit-report" />To print the VAT audit report
...
## <a name="to-print-the-vat-entry-exception-report" />To print the VAT entry exception report
