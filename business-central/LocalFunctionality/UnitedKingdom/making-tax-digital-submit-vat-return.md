...
ms.author: soalex
---
# <a name="making-tax-digital-in-the-united-kingdom"></a><a name="making-tax-digital-in-the-united-kingdom"></a><a name="making-tax-digital-in-the-united-kingdom"></a>Making Tax Digital in the United Kingdom
...
## <a name="making-tax-digital-for-vat-capabilities-in-dynamics-365-business-central"></a><a name="making-tax-digital-for-vat-capabilities-in-dynamics-365-business-central"></a><a name="making-tax-digital-for-vat-capabilities-in-dynamics-365-business-central"></a>Making Tax Digital for VAT capabilities in Dynamics 365 Business Central
...
## <a name="set-up-making-tax-digital-for-vat"></a><a name="set-up-making-tax-digital-for-vat"></a><a name="set-up-making-tax-digital-for-vat"></a>Set up Making Tax Digital for VAT
...
### <a name="setup-requirements-for-on-premises-versions"></a><a name="setup-requirements-for-on-premises-versions"></a><a name="setup-requirements-for-on-premises-versions"></a>Setup requirements for on-premises versions
...
## <a name="vat-obligations"></a><a name="vat-obligations"></a><a name="vat-obligations"></a>VAT obligations
...
### <a name="to-retrieve-the-vat-return-periods-from-hmrc"></a><a name="to-retrieve-the-vat-return-periods-from-hmrc"></a><a name="to-retrieve-the-vat-return-periods-from-hmrc"></a>To retrieve the VAT return periods from HMRC
...
## <a name="vat-returns"></a><a name="vat-returns"></a><a name="vat-returns"></a>VAT Returns
...
### <a name="to-create-and-submit-a-vat-return"></a><a name="to-create-and-submit-a-vat-return"></a><a name="to-create-and-submit-a-vat-return"></a>To create and submit a VAT return
...
### <a name="to-receive-previously-submitted-vat-returns-from-hmrc"></a><a name="to-receive-previously-submitted-vat-returns-from-hmrc"></a><a name="to-receive-previously-submitted-vat-returns-from-hmrc"></a>To receive previously submitted VAT returns from HMRC
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>VAT Return Statuses
...
## <a name="vat-liabilities-and-payments"></a><a name="vat-liabilities-and-payments"></a><a name="vat-liabilities-and-payments"></a>VAT liabilities and payments
...
## <a name="not-in-scope-of-this-feature"></a><a name="not-in-scope-of-this-feature"></a><a name="not-in-scope-of-this-feature"></a>Not in scope of this feature
...
## <a name="connection-errors-with-hmrc"></a><a name="connection-errors-with-hmrc"></a><a name="connection-errors-with-hmrc"></a>Connection errors with HMRC
...
## <a name="testing-the-integration-to-hmrc-in-a-sandbox"></a><a name="testing-the-integration-to-hmrc-in-a-sandbox"></a><a name="testing-the-integration-to-hmrc-in-a-sandbox"></a>Testing the integration to HMRC in a sandbox
