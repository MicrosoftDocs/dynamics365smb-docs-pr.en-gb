...
ms.author: soalex
---
# <a name="making-tax-digital-in-the-united-kingdom" />Making Tax Digital in the United Kingdom
...
## <a name="set-up-making-tax-digital-for-vat" />Set up Making Tax Digital for VAT
...
### <a name="setup-requirements-for-on-premises-versions" />Setup requirements for on-premises versions
...
## <a name="vat-obligations" />VAT obligations
...
### <a name="to-retrieve-the-vat-return-periods-from-hmrc" />To retrieve the VAT return periods from HMRC
...
## <a name="vat-returns" />VAT Returns
...
### <a name="to-create-and-submit-a-vat-return" />To create and submit a VAT return
...
### <a name="to-receive-previously-submitted-vat-returns-from-hmrc" />To receive previously submitted VAT returns from HMRC
...
### <a name="vat-return-statuses" />VAT Return Statuses
...
## <a name="vat-liabilities-and-payments" />VAT liabilities and payments
...
## <a name="not-in-scope-of-this-feature" />Not in scope of this feature
...
## <a name="connection-errors-with-hmrc" />Connection errors with HMRC
...
## <a name="testing-the-integration-to-hmrc-in-a-sandbox" />Testing the integration to HMRC in a sandbox
