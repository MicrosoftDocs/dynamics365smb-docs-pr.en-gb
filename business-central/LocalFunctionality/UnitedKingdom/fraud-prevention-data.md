...
ms.author: edupont
---
# <a name="send-fraud-prevention-data-in-the-united-kingdom" />Send Fraud Prevention Data in the United Kingdom
...
## <a name="fraud-prevention-headers" />Fraud prevention headers
...
## <a name="populating-headers" />Populating headers
...
## <a name="ip-addresses" />IP addresses
