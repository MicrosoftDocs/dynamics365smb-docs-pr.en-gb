...
ms.author: edupont
---
# <a name="send-fraud-prevention-data-in-the-united-kingdom"></a><a name="send-fraud-prevention-data-in-the-united-kingdom"></a>Send Fraud Prevention Data in the United Kingdom
...
## <a name="fraud-prevention-headers"></a><a name="fraud-prevention-headers"></a>Fraud prevention headers
...
## <a name="populating-headers"></a><a name="populating-headers"></a>Populating headers
...
## <a name="ip-addresses"></a><a name="ip-addresses"></a>IP addresses
