...
ms.author: bholtorf
---
# <a name="set-up-the-getaddressio-uk-postcodes-extension-in-the-british-version" />Set Up the GetAddress.io UK Postcodes Extension in the British Version
...
## <a name="to-set-up-the-getaddressio-uk-postcodes-extension" />To set up the GetAddress.io UK Postcodes extension
