...
ms.author: edupont
---
# <a name="define-accounting-periods-for-straight-line-depreciation-of-fixed-assets" />Define Accounting Periods for Straight-Line Depreciation of Fixed Assets
...
### <a name="to-define-accounting-periods-to-calculate-straight-line-depreciation" />To define accounting periods to calculate straight line depreciation
...
## <a name="to-define-accounting-periods-in-the-fa---projected-value-report" />To define accounting periods in the FA - Projected Value report
