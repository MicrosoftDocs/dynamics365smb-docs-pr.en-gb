...
# <a name="the-getaddressio-uk-postcodes-extension-in-the-british-version" />The GetAddress.io UK Postcodes Extension in the British Version
...
## <a name="to-use-the-getaddressio-uk-postcodes-extension-when-you-enter-an-address" />To use the GetAddress.io UK postcodes extension when you enter an address
