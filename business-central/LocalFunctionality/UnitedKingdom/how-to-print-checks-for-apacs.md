...
ms.author: edupont
---
# <a name="print-checks-for-apacs"></a><a name="print-checks-for-apacs"></a>Print Cheques for APACS
...
## <a name="to-print-checks-for-apacs"></a><a name="to-print-checks-for-apacs"></a>To print cheques for APACS
