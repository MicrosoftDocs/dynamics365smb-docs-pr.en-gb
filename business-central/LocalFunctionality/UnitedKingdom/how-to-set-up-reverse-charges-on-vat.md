...
ms.author: edupont
---
# <a name="set-up-reverse-charge-vat-in-the-british-version" />Set Up Reverse Charge VAT in the British Version
...
## <a name="to-reverse-charges-on-vat" />To reverse charges on VAT
...
## <a name="reverse-charge-sales-list" />Reverse Charge Sales List
