...
ms.author: edupont
---
# <a name="set-up-reverse-charge-vat-in-the-british-version"></a><a name="set-up-reverse-charge-vat-in-the-british-version"></a>Set Up Reverse Charge VAT in the British Version
...
## <a name="to-reverse-charges-on-vat"></a><a name="to-reverse-charges-on-vat"></a>To reverse charges on VAT
...
## <a name="reverse-charge-sales-list"></a><a name="reverse-charge-sales-list"></a>Reverse Charge Sales List
