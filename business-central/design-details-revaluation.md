...
ms.author: edupont
---
# <a name="design-details-revaluation"></a><a name="design-details-revaluation"></a>Design Details: Revaluation
...
## <a name="calculating-the-revaluable-quantity"></a><a name="calculating-the-revaluable-quantity"></a>Calculating the Revaluable Quantity
...
## <a name="expected-cost-in-revaluation"></a><a name="expected-cost-in-revaluation"></a>Expected Cost in Revaluation
...
## <a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a><a name="determining-whether-an-inventory-decrease-is-affected-by-revaluation"></a>Determining Whether a Inventory Decrease is Affected by Revaluation
...
### <a name="example-2"></a><a name="example-2"></a>Example
...
## <a name="wip-inventory-revaluation"></a><a name="wip-inventory-revaluation"></a>WIP Inventory Revaluation
