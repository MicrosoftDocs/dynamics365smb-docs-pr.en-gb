...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Set Up Shop Calendars
...
## <a name="to-create-work-shifts" />To create work shifts
...
## <a name="to-set-up-a-shop-calendar" />To set up a shop calendar
...
## <a name="to-calculate-a-work-center-calendar" />To calculate a work centre calendar
...
## <a name="to-record-work-center-absence" />To record work centre absence
