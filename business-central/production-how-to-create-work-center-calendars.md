...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Set Up Shop Calendars
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>To create work shifts
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>To set up a shop calendar
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>To calculate a work centre calendar
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>To record work centre absence
