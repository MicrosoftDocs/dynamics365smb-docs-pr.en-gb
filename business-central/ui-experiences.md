...
ms.author: edupont
---
# <a name="change-which-features-are-displayed" />Change Which Features are Displayed
...
## <a name="enabling-premium-features-after-upgrading-a-plan" />Enabling Premium Features after Upgrading a Plan
...
### <a name="to-update-plan-changes-in-users-groups" />To update plan changes in users groups
...
### <a name="to-select-the-premium-experience" />To select the Premium experience
...
## <a name="help-assumes-premium-experience" />Help Assumes Premium Experience
