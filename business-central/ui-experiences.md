...
> [!NOTE]  
> This setting applies to all users in your company. Users can customise their own experience even further by changing page layouts and content. For more information, see [Personalise Your Workspace](ui-personalization-user.md).  
