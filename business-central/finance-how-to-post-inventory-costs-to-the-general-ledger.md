...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Reconcile Inventory Costs with the General Ledger
...
## <a name="to-post-inventory-costs-manually" />To post inventory costs manually
...
## <a name="to-audit-the-reconciliation-between-the-inventory-ledger-and-the-general-ledger" />To audit the reconciliation between the inventory ledger and the general ledger
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Reporting Costs and Reconciling with the General Ledger
