...
ms.author: bholtorf
---
# <a name="allocate-costs-to-intercompany-partners" />Allocate Costs to Intercompany Partners
...
## <a name="to-allocate-costs-using-an-intercompany-general-journal" />To allocate costs using an intercompany general journal
...
## <a name="to-allocate-costs-using-a-purchase-document" />To allocate costs using a purchase document
...
## <a name="to-send-the-allocated-costs-to-intercompany-partners" />To send the allocated costs to intercompany partners
...
## <a name="calculating-vat-for-cost-distributions" />Calculating VAT for Cost Distributions
