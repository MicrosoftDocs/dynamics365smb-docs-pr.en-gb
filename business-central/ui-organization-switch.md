...
# <a name="switching-to-another-company-or-environment" />Switching to Another Company or Environment
...
## <a name="about-companies-and-environments" />About companies and environments
...
## <a name="features-for-switching-company-or-environment" />Features for switching company or environment
...
## <a name="use-the-company-switcher" />Use the company switcher
...
## <a name="use-the-app-launcher" />Use the app launcher
...
-->
## <a name="use-my-settings" />Use My Settings
...
## <a name="use-company-hub" />Use company hub
