...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue"></a><a name="design-details-known-item-application-issue"></a>Design Details: Known Item Application Issue
...
## <a name="symptoms-of-the-issue"></a><a name="symptoms-of-the-issue"></a>Symptoms of the Issue
...
## <a name="basics-of-item-application"></a><a name="basics-of-item-application"></a>Basics of Item Application
...
### <a name="quantity-application"></a><a name="quantity-application"></a>Quantity Application
...
### <a name="cost-application"></a><a name="cost-application"></a>Cost Application
...
## <a name="illustration-of-a-basic-cost-flow"></a><a name="illustration-of-a-basic-cost-flow"></a>Illustration of a Basic Cost Flow
...
## <a name="reasons-for-the-issue"></a><a name="reasons-for-the-issue"></a>Reasons for the Issue
...
## <a name="identifying-the-issue"></a><a name="identifying-the-issue"></a>Identifying the Issue
...
## <a name="workaround-for-the-issue"></a><a name="workaround-for-the-issue"></a>Workaround for the Issue
