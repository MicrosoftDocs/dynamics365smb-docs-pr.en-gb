...
||**Adjust Exch. Rates**|Adjust general ledger, customer, supplier, and bank account entries to reflect a more updated balance if the exchange rate has changed since the entries were posted.|
