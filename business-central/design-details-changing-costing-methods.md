...
# <a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a>Design Details: Change the Costing Method for Items
...
## <a name="about-costing-methods"></a><a name="about-costing-methods"></a>About Costing Methods
...
## <a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a>Use Assembly Orders to Change Costing Method Assignments
...
### <a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a>Define a default costing method
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them"></a><a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them"></a>Identify the items to change the costing method for and renumber them
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a>Create new items with the old numbering scheme and copy the master data in a batch
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a>Manually copy related master data from the original item to the new item
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item"></a><a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item"></a>Determine the inventory quantity to convert from the original item to the new item
...
### <a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a>Transfer the inventory to the new item
...
#### <a name="lines"></a><a name="lines"></a>Lines
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a>Handle inventory quantities that are allocated to demand
...
### <a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a>Block the original item from further use
...
## <a name="summary"></a><a name="summary"></a>Summary
