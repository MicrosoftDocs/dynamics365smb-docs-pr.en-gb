...
ms.author: edupont
---
# <a name="create-routings" />Create Routings
...
## <a name="to-create-a-routing" />To create a routing
...
## <a name="to-create-routing-links" />To create routing links
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />To assign personnel, tools, and quality measures to routing operations
...
## <a name="to-create-a-new-versions-of-a-routing" />To create a new versions of a routing
