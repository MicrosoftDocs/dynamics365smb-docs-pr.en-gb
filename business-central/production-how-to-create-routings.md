...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a><a name="create-routings"></a>Create Routings
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>To create a routing
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>To create routing links
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>To assign personnel, tools, and quality measures to routing operations
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>To create a new versions of a routing
