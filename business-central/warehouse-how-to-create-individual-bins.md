...
ms.author: edupont
---
# <a name="create-bins" />Create Bins
...
## <a name="to-create-a-bin-from-the-location-card" />To create a bin from the location card
...
### <a name="the-dedicated-field" />The Dedicated field
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />To create bins individually in the bin creation worksheet
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />To make bins automatically in the bin creation worksheet
...
## <a name="see-related-microsoft-trainingtrainingmodulescreate-new-bins" />See related [Microsoft training](/training/modules/create-new-bins/)
