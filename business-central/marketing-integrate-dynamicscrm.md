...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Use Dynamics 365 Sales from Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a><a name="coupling-records"></a>Coupling Records
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Fully Synchronising Records
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Handling Sales Order Data
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Handling Sales Quotes Data
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Handling Posted Sales Invoices, Customer Payments, and Statistics
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Handling Sales Prices
> [!NOTE]
