...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Integrating with Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Integrating Through Dataverse
...
### <a name="connection-settings-in-the-setup-guide" />Connection Settings in the Setup Guide
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Connection Settings on the Microsoft Dynamics 365 Connection Setup Page
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standard Sales Entity Mapping for Synchronisation
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synchronising Items and Resources with Products with Different Units of Measurement
...
### <a name="mapping-items-and-resources-to-products" />Mapping Items and Resources to Products
...
### <a name="synchronization-rules" />Synchronisation Rules
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synchronisation Jobs for a Sales Integration
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Connecting to On-Premises Versions of Business Central 2019 release wave 1 and Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />To connect Business Central 2019 release wave 1 and Dynamics NAV 2018
