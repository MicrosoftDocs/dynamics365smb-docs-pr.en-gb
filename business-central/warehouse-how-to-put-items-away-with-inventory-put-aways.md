...
---
# <a name="put-items-away-with-inventory-put-aways" />Put Items Away with Inventory Put-aways
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />To create a inventory put-away from the source document
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />To create multiple inventory put-aways with a batch job
...
## <a name="to-create-the-put-away-in-two-steps" />To create the put-away in two steps

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />To request a inventory put-away by releasing the source document
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />To create a inventory put-away based on the source document
...
## <a name="to-record-the-inventory-put-away" />To record the inventory put-away
