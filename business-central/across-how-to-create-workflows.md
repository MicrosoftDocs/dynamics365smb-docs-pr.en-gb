...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes"></a><a name="create-workflows-to-connect-tasks-in-business-processes"></a><a name="create-workflows-to-connect-tasks-in-business-processes"></a>Create Workflows to Connect Tasks in Business Processes
...
## <a name="to-create-a-workflow"></a><a name="to-create-a-workflow"></a><a name="to-create-a-workflow"></a>To create a workflow
...
## <a name="example-of-creating-a-new-workflow-using-existing-events"></a><a name="example-of-creating-a-new-workflow-using-existing-events"></a><a name="example-of-creating-a-new-workflow-using-existing-events"></a>Example of creating a new workflow using existing events
