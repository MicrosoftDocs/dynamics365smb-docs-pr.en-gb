...
# <a name="setting-up-included365finlongincludesd365finlongmdmd-to-calculate-and-post-value-added-tax"></a>Setting up [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] to Calculate and Post Value Added Tax
...
## <a name="use-the-vat-setup-assisted-setup-guide-to-set-up-vat-recommended"></a>Use the VAT Setup assisted setup guide to set up VAT (recommended)
...
## <a name="assign-vat-posting-groups-to-individual-accounts-customers-vendors-items-and-resources"></a>Assign VAT posting groups to individual accounts, customers, vendors, items, and resources
...
## <a name="set-up-clauses-to-explain-the-use-of-non-standard-vat-rates"></a>Set up clauses to explain the use of non-standard VAT rates
