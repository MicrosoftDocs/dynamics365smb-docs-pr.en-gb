...
> [!NOTE]  
> This setting applies to all users in your company. Users can customise thier own experience even further by changing page layouts and content. For more information, see [Personalising Your Workspace and Pages](ui-personalization-user.md).  
