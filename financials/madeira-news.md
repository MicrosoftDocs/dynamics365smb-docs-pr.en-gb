...
## <a name="november-2016-launch-of-included365finlongincludesd365finlongmdmd"></a>November 2016 Launch of [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)]
...
### <a name="new-extension-for-migrating-data-from-dynamics-gp"></a>New extension for migrating data from Dynamics GP
...
### <a name="cash-flow-forecasting"></a>Cash flow forecasting
...
With this update, you can create a hierarchy of item categories and assign item attributes to each item category. For more information, see [Categorise Items](inventory-how-categorize-items.md).

### <a name="send-purchase-orders-to-vendors"></a>Send purchase orders to vendors
...
### <a name="better-quality-incoming-documents"></a>Better quality incoming documents
...
## <a name="august-2016-update"></a>August 2016 Update
...
### <a name="smart-notifications-give-you-advice-and-recommendations"></a>Smart notifications give you advice and recommendations
...
### <a name="introducing-the-new-sales-and-inventory-forecast-extension"></a>Introducing the new Sales and Inventory Forecast extension
...
###  <a name="smarter-sales-and-purchase-documents"></a>Smarter sales and purchase documents
...
## <a name="july-2016-update"></a>July 2016 Update
...
### <a name="working-with-incoming-documents-in-outlook"></a>Working with incoming documents in Outlook
...
### <a name="create-invoices-in-your-outlook-calendar"></a>Create invoices in your Outlook calendar
...
### <a name="appsource-marketplace-for-extensions"></a>AppSource marketplace for extensions
...
### <a name="shipping-agents-and-item-attributes"></a>Shipping agents and item attributes
...
### <a name="new-extensions-made-available"></a>New extensions made available
...
### <a name="filter-on-unprocessed-incoming-documents"></a>Filter on unprocessed incoming documents
...
### <a name="office-suite-notifications-are-now-enabled-in-included365finincludesd365finmdmd"></a>Office Suite notifications are now enabled in [!INCLUDE[d365fin](includes/d365fin_md.md)]
...
## <a name="april-2016-preview"></a>April 2016 Preview
