...
### <a name="to-calculate-the-expected-inventory"></a>To calculate the expected inventory
...
### <a name="to-print-the-report-used-when-counting"></a>To print the report used when counting
...
### <a name="to-enter-and-post-the-actual-counted-inventory"></a>To enter and post the actual counted inventory
...
## <a name="to-initiate-a-count-based-on-counting-periods"></a>To initiate a count based on counting periods
...
## <a name="to-adjust-the-inventory-quantity-of-one-or-more-items"></a>To adjust the inventory quantity of one or more items
