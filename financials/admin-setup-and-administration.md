...
---
# <a name="setup-and-administration-in-finance-and-operations-business-edition"></a>Setup and Administration in Finance and Operations, Business edition
...
|**To**|**See**|  
|------------|-------------|  
|Add users, manage permissions and access to data, assign roles.|[Users, Profiles, and Role Centres in Finance and Operations, Business edition](admin-users-profiles-roles.md)|  
