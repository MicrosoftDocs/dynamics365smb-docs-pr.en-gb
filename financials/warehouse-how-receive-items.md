...
3.  Choose the **Get Source Documents** action. The **Source Documents** window opens.
    ...
    All released source document lines that fulfil the filter criteria are now inserted in **Warehouse Receipt** window from which you activated the filter function.  
