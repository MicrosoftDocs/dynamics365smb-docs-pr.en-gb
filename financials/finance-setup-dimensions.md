...
description: You can define the dimensions and dimension values you want to use to categorise journals and documents, such as sales orders and purchase orders.
...
## <a name="translate-the-names-of-dimensions"></a>Translate the names of dimensions
