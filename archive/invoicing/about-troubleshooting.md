...
---
# <a name="troubleshooting-d365inv_long"></a>Troubleshooting [!INCLUDE[d365inv_long](includes/d365inv_long.md)]
> [!Note]
...
## <a name="can-i-get-training-in-d365inv"></a>Can I get training in [!INCLUDE[d365inv](includes/d365inv.md)]?
Not yet.  

## <a name="who-has-access-to-d365inv"></a>Who has access to [!INCLUDE[d365inv](includes/d365inv.md)]?
...
## <a name="why-cant-i-use-my-dynamics-365-company-in-d365inv"></a>Why can't I use my Dynamics 365 company in [!INCLUDE[d365inv](includes/d365inv.md)]?
